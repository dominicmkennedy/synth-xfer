...
def call_llm(prompt: str, api_key: str, model: str = "gpt-4") -> str:
    ...
    response = client.chat.completions.create(
        model=model,
        messages=[
            {"role": "system", "content": "You are an expert in MLIR and abstract interpretation. Your task is to generate sound and highly precise abstract transformers for the given operation. Generate only the requested MLIR code without any explanation or markdown formatting."},
