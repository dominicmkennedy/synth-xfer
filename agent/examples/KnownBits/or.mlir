func.func @KnownBits_or(%lhs : !transfer.abs_value<[!transfer.integer, !transfer.integer]>, %rhs : !transfer.abs_value<[!transfer.integer, !transfer.integer]>) -> !transfer.abs_value<[!transfer.integer, !transfer.integer]> {
  ...
  %res0 = transfer.and %lhs0, %rhs0 : !transfer.integer
  %res1 = transfer.or %lhs1, %rhs1 : !transfer.integer
