...
def rewrite_single_function_to_exprs(
    ...
    *,
    ...
    Args:
        ...
        max_iterations: Maximum number of egraph saturation passes.
    ...
    if not quiet:
        print(f"AbsValue: {previous_cost} -> {new_cost}")
...
def rewrite_single_function(
    ...
    *,
    ...
    joint, cmp_predicates = rewrite_single_function_to_exprs(
        func, domain=domain, quiet=quiet, max_iterations=max_iterations
    )
