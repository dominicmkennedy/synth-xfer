"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer):
    %2 = "transfer.ashr"(%1, %0) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    "func.return"(%2) : (!transfer.integer) -> ()
  }) : () -> ()
  "func.func"() <{sym_name = "op_constraint", function_type = (!transfer.integer, !transfer.integer) -> i1}> ({
  ^0(%0 : !transfer.integer, %1 : !transfer.integer):
    %2 = "arith.constant"() <{value = true}> : () -> i1
    %3 = "transfer.ashr"(%1, %0) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %4 = "func.call"(%1, %0) <{callee = @ashr_exact}> : (!transfer.integer, !transfer.integer) -> i1
