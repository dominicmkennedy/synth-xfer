"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer):
    ...
    %5 = "transfer.ashr"(%3, %0) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %6 = "func.call"(%3, %0) <{callee = @ashr_exact}> : (!transfer.integer, !transfer.integer) -> i1
    %7 = "func.call"(%3, %0) <{callee = @shifting_amount_less_bitwidth}> : (!transfer.integer, !transfer.integer) -> i1
