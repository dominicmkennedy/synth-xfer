"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer):
    ...
    %4 = "func.call"(%0, %1) <{callee = @add_nuw}> : (!transfer.integer, !transfer.integer) -> i1
    %5 = "transfer.shl"(%3, %1) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %6 = "func.call"(%3, %1) <{callee = @shl_nuw}> : (!transfer.integer, !transfer.integer) -> i1
    %7 = "func.call"(%3, %1) <{callee = @shifting_amount_less_bitwidth}> : (!transfer.integer, !transfer.integer) -> i1
    %8 = "arith.andi"(%2, %4) : (i1, i1) -> i1
