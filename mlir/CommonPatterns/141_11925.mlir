"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer, %4 : !transfer.integer):
    ...
    %11 = "func.call"(%1, %7) <{callee = @add_nuw}> : (!transfer.integer, !transfer.integer) -> i1
    %12 = "func.call"(%1, %7) <{callee = @add_nsw}> : (!transfer.integer, !transfer.integer) -> i1
    %13 = "transfer.lshr"(%10, %0) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %14 = "func.call"(%10, %0) <{callee = @shifting_amount_less_bitwidth}> : (!transfer.integer, !transfer.integer) -> i1
