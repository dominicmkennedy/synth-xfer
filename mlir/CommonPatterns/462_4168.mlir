"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer, %4 : !transfer.integer):
    ...
    %6 = "transfer.shl"(%2, %1) : (!transfer.integer, !transfer.integer) -> !transfer.integer
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer, %4 : !transfer.integer):
    ...
    %7 = "func.call"(%3, %4) <{callee = @or_disjoint}> : (!transfer.integer, !transfer.integer) -> i1
    %8 = "transfer.shl"(%2, %1) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %9 = "func.call"(%2, %1) <{callee = @shl_nuw}> : (!transfer.integer, !transfer.integer) -> i1
    %10 = "func.call"(%2, %1) <{callee = @shl_nsw}> : (!transfer.integer, !transfer.integer) -> i1
    %11 = "func.call"(%2, %1) <{callee = @shifting_amount_less_bitwidth}> : (!transfer.integer, !transfer.integer) -> i1
    %12 = "transfer.or"(%6, %8) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %13 = "func.call"(%6, %8) <{callee = @or_disjoint}> : (!transfer.integer, !transfer.integer) -> i1
