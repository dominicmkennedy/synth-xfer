"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer):
    ...
    %8 = "func.call"(%4, %0) <{callee = @shifting_amount_less_bitwidth}> : (!transfer.integer, !transfer.integer) -> i1
    %9 = "transfer.or"(%0, %6) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %10 = "func.call"(%0, %6) <{callee = @or_disjoint}> : (!transfer.integer, !transfer.integer) -> i1
