"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer):
    ...
    %5 = "transfer.and"(%1, %4) : (!transfer.integer, !transfer.integer) -> !transfer.integer
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer):
    ...
    %9 = "transfer.and"(%1, %5) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %10 = "transfer.or"(%0, %9) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %11 = "func.call"(%0, %9) <{callee = @or_disjoint}> : (!transfer.integer, !transfer.integer) -> i1
