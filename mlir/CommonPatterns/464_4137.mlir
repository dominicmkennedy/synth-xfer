"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer):
    ...
    %4 = "transfer.lshr"(%2, %0) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %5 = "func.call"(%2, %0) <{callee = @shifting_amount_less_bitwidth}> : (!transfer.integer, !transfer.integer) -> i1
    %6 = "transfer.add"(%1, %4) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %7 = "func.call"(%1, %4) <{callee = @add_nuw}> : (!transfer.integer, !transfer.integer) -> i1
    %8 = "transfer.shl"(%6, %0) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %9 = "func.call"(%6, %0) <{callee = @shl_nuw}> : (!transfer.integer, !transfer.integer) -> i1
    %10 = "func.call"(%6, %0) <{callee = @shifting_amount_less_bitwidth}> : (!transfer.integer, !transfer.integer) -> i1
