"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer):
    ...
    %6 = "transfer.lshr"(%3, %1) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %7 = "func.call"(%3, %1) <{callee = @shifting_amount_less_bitwidth}> : (!transfer.integer, !transfer.integer) -> i1
    %8 = "transfer.or"(%3, %6) : (!transfer.integer, !transfer.integer) -> !transfer.integer
