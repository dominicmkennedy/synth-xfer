"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer):
    ...
    %5 = "func.call"(%1, %0) <{callee = @shifting_amount_less_bitwidth}> : (!transfer.integer, !transfer.integer) -> i1
    %6 = "transfer.or"(%0, %3) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %7 = "func.call"(%0, %3) <{callee = @or_disjoint}> : (!transfer.integer, !transfer.integer) -> i1
    %8 = "arith.andi"(%2, %4) : (i1, i1) -> i1
    %9 = "arith.andi"(%8, %5) : (i1, i1) -> i1
