"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer, %4 : !transfer.integer):
    ...
    %7 = "transfer.lshr"(%2, %0) : (!transfer.integer, !transfer.integer) -> !transfer.integer
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer, %4 : !transfer.integer):
    ...
    %7 = "transfer.lshr"(%2, %1) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %8 = "func.call"(%2, %1) <{callee = @shifting_amount_less_bitwidth}> : (!transfer.integer, !transfer.integer) -> i1
    %9 = "transfer.lshr"(%2, %0) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %10 = "func.call"(%2, %0) <{callee = @shifting_amount_less_bitwidth}> : (!transfer.integer, !transfer.integer) -> i1
    %11 = "transfer.xor"(%7, %9) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %12 = "transfer.and"(%6, %11) : (!transfer.integer, !transfer.integer) -> !transfer.integer
