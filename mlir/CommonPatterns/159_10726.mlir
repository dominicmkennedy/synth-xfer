"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer):
    ...
    %4 = "func.call"(%1, %0) <{callee = @shl_nuw}> : (!transfer.integer, !transfer.integer) -> i1
    %5 = "func.call"(%1, %0) <{callee = @shl_nsw}> : (!transfer.integer, !transfer.integer) -> i1
    %6 = "func.call"(%1, %0) <{callee = @shifting_amount_less_bitwidth}> : (!transfer.integer, !transfer.integer) -> i1
    %7 = "transfer.or"(%0, %3) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %8 = "func.call"(%0, %3) <{callee = @or_disjoint}> : (!transfer.integer, !transfer.integer) -> i1
    %9 = "arith.andi"(%2, %4) : (i1, i1) -> i1
    %10 = "arith.andi"(%9, %5) : (i1, i1) -> i1
