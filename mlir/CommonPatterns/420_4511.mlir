"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer):
    ...
    %6 = "transfer.ashr"(%5, %0) : (!transfer.integer, !transfer.integer) -> !transfer.integer
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer):
    ...
    %6 = "func.call"(%2, %3) <{callee = @mul_nsw}> : (!transfer.integer, !transfer.integer) -> i1
    ...
    %9 = "transfer.ashr"(%7, %0) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %10 = "func.call"(%7, %0) <{callee = @shifting_amount_less_bitwidth}> : (!transfer.integer, !transfer.integer) -> i1
