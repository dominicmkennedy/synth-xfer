"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer):
    ...
    %6 = "transfer.lshr"(%2, %0) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %7 = "func.call"(%2, %0) <{callee = @shifting_amount_less_bitwidth}> : (!transfer.integer, !transfer.integer) -> i1
