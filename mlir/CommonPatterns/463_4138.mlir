"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer):
    ...
    %7 = "transfer.shl"(%4, %0) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %8 = "func.call"(%4, %0) <{callee = @shl_nuw}> : (!transfer.integer, !transfer.integer) -> i1
    %9 = "func.call"(%4, %0) <{callee = @shl_nsw}> : (!transfer.integer, !transfer.integer) -> i1
    %10 = "func.call"(%4, %0) <{callee = @shifting_amount_less_bitwidth}> : (!transfer.integer, !transfer.integer) -> i1
