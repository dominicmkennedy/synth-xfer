"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer):
    ...
    %11 = "transfer.lshr"(%8, %0) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %12 = "func.call"(%8, %0) <{callee = @shifting_amount_less_bitwidth}> : (!transfer.integer, !transfer.integer) -> i1
