"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer):
    ...
    %9 = "transfer.or"(%0, %1) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %10 = "func.call"(%0, %1) <{callee = @or_disjoint}> : (!transfer.integer, !transfer.integer) -> i1
    %11 = "transfer.or"(%5, %9) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %12 = "func.call"(%5, %9) <{callee = @or_disjoint}> : (!transfer.integer, !transfer.integer) -> i1
    %13 = "arith.andi"(%4, %6) : (i1, i1) -> i1
    %14 = "arith.andi"(%13, %7) : (i1, i1) -> i1
    %15 = "arith.andi"(%14, %8) : (i1, i1) -> i1
