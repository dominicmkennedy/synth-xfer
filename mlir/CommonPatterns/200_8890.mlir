"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer):
    %3 = "transfer.sdiv"(%2, %0) : (!transfer.integer, !transfer.integer) -> !transfer.integer
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer):
    ...
    %4 = "transfer.sdiv"(%2, %0) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %5 = "func.call"(%2, %0) <{callee = @sidv_exact}> : (!transfer.integer, !transfer.integer) -> i1
    %6 = "func.call"(%2, %0) <{callee = @rhs_neq_zero}> : (!transfer.integer, !transfer.integer) -> i1
