"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer):
    ...
    %5 = "func.call"(%1, %3) <{callee = @add_nuw}> : (!transfer.integer, !transfer.integer) -> i1
    %6 = "func.call"(%1, %3) <{callee = @add_nsw}> : (!transfer.integer, !transfer.integer) -> i1
    %7 = "arith.andi"(%2, %5) : (i1, i1) -> i1
