"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer):
    %3 = "transfer.ashr"(%2, %1) : (!transfer.integer, !transfer.integer) -> !transfer.integer
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer):
    ...
    %4 = "transfer.ashr"(%2, %1) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %5 = "func.call"(%2, %1) <{callee = @ashr_exact}> : (!transfer.integer, !transfer.integer) -> i1
    %6 = "func.call"(%2, %1) <{callee = @shifting_amount_less_bitwidth}> : (!transfer.integer, !transfer.integer) -> i1
