"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer, %4 : !transfer.integer, %5 : !transfer.integer):
    ...
    %7 = "transfer.lshr"(%4, %2) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %8 = "transfer.or"(%6, %7) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %9 = "transfer.lshr"(%8, %1) : (!transfer.integer, !transfer.integer) -> !transfer.integer
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer, %4 : !transfer.integer, %5 : !transfer.integer):
    ...
    %8 = "transfer.lshr"(%4, %2) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %9 = "func.call"(%4, %2) <{callee = @shifting_amount_less_bitwidth}> : (!transfer.integer, !transfer.integer) -> i1
    %10 = "transfer.or"(%7, %8) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %11 = "transfer.lshr"(%10, %1) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %12 = "func.call"(%10, %1) <{callee = @shifting_amount_less_bitwidth}> : (!transfer.integer, !transfer.integer) -> i1
