module {
  func.func @concrete_op(%arg0: !transfer.integer, %arg1: !transfer.integer, %arg2: !transfer.integer, %arg3: !transfer.integer, %arg4: !transfer.integer) -> !transfer.integer {
    ...
    %2 = "transfer.lshr"(%1, %arg3) : (!transfer.integer, !transfer.integer) -> !transfer.integer
  ...
  func.func @op_constraint(%arg0: !transfer.integer, %arg1: !transfer.integer, %arg2: !transfer.integer, %arg3: !transfer.integer, %arg4: !transfer.integer) -> i1 {
    ...
    %3 = "transfer.lshr"(%2, %arg3) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %4 = call @shifting_amount_less_bitwidth(%2, %arg3) : (!transfer.integer, !transfer.integer) -> i1
    %5 = "transfer.or"(%arg1, %3) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %6 = "transfer.lshr"(%5, %arg0) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %7 = call @shifting_amount_less_bitwidth(%5, %arg0) : (!transfer.integer, !transfer.integer) -> i1
