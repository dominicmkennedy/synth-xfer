"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer):
    ...
    %6 = "func.call"(%0, %4) <{callee = @shl_nuw}> : (!transfer.integer, !transfer.integer) -> i1
    %7 = "func.call"(%0, %4) <{callee = @shl_nsw}> : (!transfer.integer, !transfer.integer) -> i1
    %8 = "func.call"(%0, %4) <{callee = @shifting_amount_less_bitwidth}> : (!transfer.integer, !transfer.integer) -> i1
