module {
  ...
  func.func @op_constraint(%arg0: !transfer.integer, %arg1: !transfer.integer, %arg2: !transfer.integer) -> i1 {
    ...
    %ssa_1_con_1_z = func.call @shl_nsw(%arg0, %0) : (!transfer.integer, !transfer.integer) -> i1
    %ssa_1_con_2_z = func.call @shift_lt_bw(%arg0, %0) : (!transfer.integer, !transfer.integer) -> i1
