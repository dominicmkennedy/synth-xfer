module {
  ...
  func.func @op_constraint(%arg0: !transfer.integer, %arg1: !transfer.integer, %arg2: !transfer.integer) -> i1 {
    ...
    %4 = "transfer.shl"(%2, %arg1) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %5 = call @shl_nuw(%2, %arg1) : (!transfer.integer, !transfer.integer) -> i1
    %6 = call @shifting_amount_less_bitwidth(%2, %arg1) : (!transfer.integer, !transfer.integer) -> i1
    %7 = "transfer.or"(%arg1, %4) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %8 = call @or_disjoint(%arg1, %4) : (!transfer.integer, !transfer.integer) -> i1
