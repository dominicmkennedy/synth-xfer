"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer):
    ...
    %5 = "transfer.shl"(%4, %1) : (!transfer.integer, !transfer.integer) -> !transfer.integer
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer):
    ...
    %7 = "func.call"(%0, %4) <{callee = @add_nuw}> : (!transfer.integer, !transfer.integer) -> i1
    ...
    %10 = "func.call"(%6, %1) <{callee = @shifting_amount_less_bitwidth}> : (!transfer.integer, !transfer.integer) -> i1
    %11 = "transfer.or"(%1, %8) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %12 = "func.call"(%1, %8) <{callee = @or_disjoint}> : (!transfer.integer, !transfer.integer) -> i1
    %13 = "arith.andi"(%3, %5) : (i1, i1) -> i1
