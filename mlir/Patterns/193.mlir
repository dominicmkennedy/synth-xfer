module {
  ...
  func.func @op_constraint(%arg0: !transfer.integer, %arg1: !transfer.integer, %arg2: !transfer.integer) -> i1 {
    ...
    %1 = "transfer.add"(%arg0, %0) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %1_constraint_0 = func.call @add_nuw(%arg0, %0) : (!transfer.integer, !transfer.integer) -> i1
    %2 = "transfer.shl"(%1, %arg1) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %2_constraint_0 = func.call @shl_nuw(%1, %arg1) : (!transfer.integer, !transfer.integer) -> i1
    %2_constraint_1 = func.call @shifting_amount_less_bitwidth(%1, %arg1) : (!transfer.integer, !transfer.integer) -> i1
    %3_constraint_0 = func.call @or_disjoint(%arg1, %2) : (!transfer.integer, !transfer.integer) -> i1
    %and_0 = arith.andi %0_constraint_0, %1_constraint_0 : i1
    %and_1 = arith.andi %and_0, %2_constraint_0 : i1
    %and_2 = arith.andi %and_1, %2_constraint_1 : i1
    %and_3 = arith.andi %and_2, %3_constraint_0 : i1
    return %and_3 : i1
  }
