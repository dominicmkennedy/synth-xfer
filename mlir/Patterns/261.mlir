module {
  func.func @concrete_op(%arg0: !transfer.integer, %arg1: !transfer.integer, %arg2: !transfer.integer, %arg3: !transfer.integer, %arg4: !transfer.integer) -> !transfer.integer {
    ...
    %1 = "transfer.shl"(%arg2, %arg1) : (!transfer.integer, !transfer.integer) -> !transfer.integer
  ...
  func.func @op_constraint(%arg0: !transfer.integer, %arg1: !transfer.integer, %arg2: !transfer.integer, %arg3: !transfer.integer, %arg4: !transfer.integer) -> i1 {
    %0 = "transfer.shl"(%arg4, %arg3) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %0_constraint_0 = func.call @shl_nuw(%arg4, %arg3) : (!transfer.integer, !transfer.integer) -> i1
    %0_constraint_1 = func.call @shl_nsw(%arg4, %arg3) : (!transfer.integer, !transfer.integer) -> i1
    %0_constraint_2 = func.call @shifting_amount_less_bitwidth(%arg4, %arg3) : (!transfer.integer, !transfer.integer) -> i1
    %1 = "transfer.shl"(%arg2, %arg1) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %1_constraint_0 = func.call @shl_nuw(%arg2, %arg1) : (!transfer.integer, !transfer.integer) -> i1
    %1_constraint_1 = func.call @shl_nsw(%arg2, %arg1) : (!transfer.integer, !transfer.integer) -> i1
    %1_constraint_2 = func.call @shifting_amount_less_bitwidth(%arg2, %arg1) : (!transfer.integer, !transfer.integer) -> i1
    %2 = "transfer.or"(%arg0, %1) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %2_constraint_0 = func.call @or_disjoint(%arg0, %1) : (!transfer.integer, !transfer.integer) -> i1
    %3_constraint_0 = func.call @or_disjoint(%0, %2) : (!transfer.integer, !transfer.integer) -> i1
    %and_0 = arith.andi %0_constraint_0, %0_constraint_1 : i1
    %and_1 = arith.andi %and_0, %0_constraint_2 : i1
    %and_2 = arith.andi %and_1, %1_constraint_0 : i1
    %and_3 = arith.andi %and_2, %1_constraint_1 : i1
    %and_4 = arith.andi %and_3, %1_constraint_2 : i1
    %and_5 = arith.andi %and_4, %2_constraint_0 : i1
    %and_6 = arith.andi %and_5, %3_constraint_0 : i1
    return %and_6 : i1
  }
