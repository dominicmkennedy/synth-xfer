module {
  ...
  func.func @op_constraint(%arg0: !transfer.integer, %arg1: !transfer.integer, %arg2: !transfer.integer, %arg3: !transfer.integer, %arg4: !transfer.integer) -> i1 {
    %0 = "transfer.shl"(%arg4, %arg3) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %constraint_0_0 = func.call @shl_nuw(%arg4, %arg3) : (!transfer.integer, !transfer.integer) -> i1
    %constraint_0_1 = func.call @shl_nsw(%arg4, %arg3) : (!transfer.integer, !transfer.integer) -> i1
    %constraint_0_2 = func.call @shifting_amount_less_bitwidth(%arg4, %arg3) : (!transfer.integer, !transfer.integer) -> i1
    %1 = "transfer.shl"(%arg2, %arg1) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %constraint_1_0 = func.call @shl_nuw(%arg2, %arg1) : (!transfer.integer, !transfer.integer) -> i1
    %constraint_1_1 = func.call @shl_nsw(%arg2, %arg1) : (!transfer.integer, !transfer.integer) -> i1
    %constraint_1_2 = func.call @shifting_amount_less_bitwidth(%arg2, %arg1) : (!transfer.integer, !transfer.integer) -> i1
    %2 = "transfer.or"(%arg0, %1) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %constraint_2_0 = func.call @or_disjoint(%arg0, %1) : (!transfer.integer, !transfer.integer) -> i1
    %constraint_3_0 = func.call @or_disjoint(%0, %2) : (!transfer.integer, !transfer.integer) -> i1
