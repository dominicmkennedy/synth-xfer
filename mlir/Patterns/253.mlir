"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer):
    %4 = "transfer.sub"(%3, %2) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    ...
    %8 = "transfer.sub"(%3, %7) : (!transfer.integer, !transfer.integer) -> !transfer.integer
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer):
    ...
    %6 = "transfer.add"(%1, %2) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %7 = "transfer.add"(%0, %6) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %8 = "func.call"(%0, %6) <{callee = @add_nuw}> : (!transfer.integer, !transfer.integer) -> i1
    %9 = "transfer.and"(%5, %7) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %10 = "transfer.sub"(%3, %9) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %11 = "func.call"(%3, %9) <{callee = @sub_nsw}> : (!transfer.integer, !transfer.integer) -> i1
    %12 = "arith.andi"(%4, %8) : (i1, i1) -> i1
