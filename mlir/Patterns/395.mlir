module {
  ...
  func.func @op_constraint(%arg0: !transfer.integer, %arg1: !transfer.integer, %arg2: !transfer.integer, %arg3: !transfer.integer, %arg4: !transfer.integer) -> i1 {
    %0 = "transfer.add"(%arg3, %arg4) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %0_constraint_0 = func.call @add_nuw(%arg3, %arg4) : (!transfer.integer, !transfer.integer) -> i1
    %0_constraint_1 = func.call @add_nsw(%arg3, %arg4) : (!transfer.integer, !transfer.integer) -> i1
    %1 = "transfer.add"(%arg2, %0) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %1_constraint_0 = func.call @add_nuw(%arg2, %0) : (!transfer.integer, !transfer.integer) -> i1
    %1_constraint_1 = func.call @add_nsw(%arg2, %0) : (!transfer.integer, !transfer.integer) -> i1
    %2 = "transfer.add"(%arg1, %1) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %2_constraint_0 = func.call @add_nuw(%arg1, %1) : (!transfer.integer, !transfer.integer) -> i1
    %2_constraint_1 = func.call @add_nsw(%arg1, %1) : (!transfer.integer, !transfer.integer) -> i1
    %3_constraint_0 = func.call @add_nuw(%arg0, %2) : (!transfer.integer, !transfer.integer) -> i1
    %3_constraint_1 = func.call @add_nsw(%arg0, %2) : (!transfer.integer, !transfer.integer) -> i1
    ...
    %and_5 = arith.andi %and_4, %3_constraint_0 : i1
    %and_6 = arith.andi %and_5, %3_constraint_1 : i1
    return %and_6 : i1
  }
