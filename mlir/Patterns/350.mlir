module {
  ...
  func.func @op_constraint(%arg0: !transfer.integer, %arg1: !transfer.integer, %arg2: !transfer.integer, %arg3: !transfer.integer) -> i1 {
    %0 = "transfer.sub"(%arg3, %arg2) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %1 = "transfer.ashr"(%0, %arg1) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %constraint_1_0 = func.call @ashr_exact(%0, %arg1) : (!transfer.integer, !transfer.integer) -> i1
    %constraint_1_1 = func.call @shifting_amount_less_bitwidth(%0, %arg1) : (!transfer.integer, !transfer.integer) -> i1
    %constraint_2_0 = func.call @sub_nuw(%arg0, %1) : (!transfer.integer, !transfer.integer) -> i1
    %constraint_2_1 = func.call @sub_nsw(%arg0, %1) : (!transfer.integer, !transfer.integer) -> i1
