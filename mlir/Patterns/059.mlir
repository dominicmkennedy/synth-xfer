module {
  ...
  func.func @op_constraint(%arg0: !transfer.integer, %arg1: !transfer.integer, %arg2: !transfer.integer) -> i1 {
    ...
    %0 = "transfer.urem"(%arg2, %arg1) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %1 = call @rhs_neq_zero(%arg2, %arg1) : (!transfer.integer, !transfer.integer) -> i1
    %2 = "transfer.shl"(%0, %arg0) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %3 = call @shl_nuw(%0, %arg0) : (!transfer.integer, !transfer.integer) -> i1
    %4 = call @shl_nsw(%0, %arg0) : (!transfer.integer, !transfer.integer) -> i1
    %5 = call @shifting_amount_less_bitwidth(%0, %arg0) : (!transfer.integer, !transfer.integer) -> i1
