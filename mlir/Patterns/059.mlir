"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer):
    ...
    %4 = "transfer.urem"(%2, %1) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %5 = "func.call"(%2, %1) <{callee = @rhs_neq_zero}> : (!transfer.integer, !transfer.integer) -> i1
    %6 = "transfer.shl"(%4, %0) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %7 = "func.call"(%4, %0) <{callee = @shl_nuw}> : (!transfer.integer, !transfer.integer) -> i1
    %8 = "func.call"(%4, %0) <{callee = @shl_nsw}> : (!transfer.integer, !transfer.integer) -> i1
    %9 = "func.call"(%4, %0) <{callee = @shifting_amount_less_bitwidth}> : (!transfer.integer, !transfer.integer) -> i1
