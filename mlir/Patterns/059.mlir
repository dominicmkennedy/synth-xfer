module {
  func.func @concrete_op(%arg0: !transfer.integer, %arg1: !transfer.integer, %arg2: !transfer.integer) -> !transfer.integer {
    %0 = "transfer.urem"(%arg2, %arg1) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %1 = "transfer.shl"(%0, %arg0) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    return %1 : !transfer.integer
  }
  func.func @op_constraint(%arg0: !transfer.integer, %arg1: !transfer.integer, %arg2: !transfer.integer) -> i1 {
    %0 = "transfer.urem"(%arg2, %arg1) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %0_constraint_0 = func.call @rhs_neq_zero(%arg2, %arg1) : (!transfer.integer, !transfer.integer) -> i1
    %1_constraint_0 = func.call @shl_nuw(%0, %arg0) : (!transfer.integer, !transfer.integer) -> i1
    %1_constraint_1 = func.call @shl_nsw(%0, %arg0) : (!transfer.integer, !transfer.integer) -> i1
    %1_constraint_2 = func.call @shifting_amount_less_bitwidth(%0, %arg0) : (!transfer.integer, !transfer.integer) -> i1
