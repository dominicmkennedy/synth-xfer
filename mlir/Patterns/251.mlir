"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer, %4 : !transfer.integer):
    ...
    %8 = "func.call"(%1, %2) <{callee = @mul_nuw}> : (!transfer.integer, !transfer.integer) -> i1
    %9 = "transfer.add"(%0, %7) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %10 = "func.call"(%0, %7) <{callee = @add_nuw}> : (!transfer.integer, !transfer.integer) -> i1
    %11 = "transfer.and"(%6, %9) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %12 = "transfer.sub"(%4, %11) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %13 = "func.call"(%4, %11) <{callee = @sub_nsw}> : (!transfer.integer, !transfer.integer) -> i1
