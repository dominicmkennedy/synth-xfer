module {
  ...
  func.func @op_constraint(%arg0: !transfer.integer, %arg1: !transfer.integer, %arg2: !transfer.integer, %arg3: !transfer.integer, %arg4: !transfer.integer) -> i1 {
    %0 = "transfer.or"(%arg3, %arg4) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %ssa_0_con_0_z = func.call @or_disjoint(%arg3, %arg4) : (!transfer.integer, !transfer.integer) -> i1
    %1 = "transfer.shl"(%arg2, %arg1) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    ...
    %and_2 = arith.andi %and_1, %ssa_1_con_2_z : i1
    %and_3 = arith.andi %and_2, %ssa_2_con_0_z : i1
    %and_4 = arith.andi %and_3, %ssa_3_con_0_z : i1
    return %and_4 : i1
  }
