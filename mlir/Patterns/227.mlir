module {
  ...
  func.func @op_constraint(%arg0: !transfer.integer, %arg1: !transfer.integer, %arg2: !transfer.integer, %arg3: !transfer.integer, %arg4: !transfer.integer) -> i1 {
    ...
    %2 = "transfer.lshr"(%arg4, %arg2) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %3 = call @shifting_amount_less_bitwidth(%arg4, %arg2) : (!transfer.integer, !transfer.integer) -> i1
