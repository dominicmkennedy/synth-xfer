module {
  func.func @concrete_op(%arg0: !transfer.integer, %arg1: !transfer.integer, %arg2: !transfer.integer, %arg3: !transfer.integer, %arg4: !transfer.integer, %arg5: !transfer.integer) -> !transfer.integer {
    ...
    %1 = "transfer.lshr"(%0, %arg2) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %2 = "transfer.or"(%arg4, %1) : (!transfer.integer, !transfer.integer) -> !transfer.integer
  ...
  func.func @op_constraint(%arg0: !transfer.integer, %arg1: !transfer.integer, %arg2: !transfer.integer, %arg3: !transfer.integer, %arg4: !transfer.integer, %arg5: !transfer.integer) -> i1 {
    ...
    %0 = "transfer.or"(%arg3, %arg5) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %1 = "transfer.lshr"(%0, %arg2) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %2 = call @shifting_amount_less_bitwidth(%0, %arg2) : (!transfer.integer, !transfer.integer) -> i1
    %3 = "transfer.or"(%arg4, %1) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %4 = "transfer.lshr"(%3, %arg1) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %5 = call @shifting_amount_less_bitwidth(%3, %arg1) : (!transfer.integer, !transfer.integer) -> i1
    %6 = "transfer.or"(%arg0, %4) : (!transfer.integer, !transfer.integer) -> !transfer.integer
