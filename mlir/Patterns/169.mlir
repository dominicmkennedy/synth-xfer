module {
  func.func @concrete_op(%arg0: !transfer.integer, %arg1: !transfer.integer, %arg2: !transfer.integer) -> !transfer.integer {
    %0 = "transfer.ashr"(%arg2, %arg0) : (!transfer.integer, !transfer.integer) -> !transfer.integer
  ...
  func.func @op_constraint(%arg0: !transfer.integer, %arg1: !transfer.integer, %arg2: !transfer.integer) -> i1 {
    ...
    %0 = "transfer.ashr"(%arg2, %arg0) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %1 = call @ashr_exact(%arg2, %arg0) : (!transfer.integer, !transfer.integer) -> i1
    %2 = call @shifting_amount_less_bitwidth(%arg2, %arg0) : (!transfer.integer, !transfer.integer) -> i1
    %3 = "transfer.sub"(%arg1, %0) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %4 = call @sub_nsw(%arg1, %0) : (!transfer.integer, !transfer.integer) -> i1
