"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer):
    %3 = "transfer.ashr"(%2, %0) : (!transfer.integer, !transfer.integer) -> !transfer.integer
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer):
    ...
    %4 = "transfer.ashr"(%2, %0) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %5 = "func.call"(%2, %0) <{callee = @ashr_exact}> : (!transfer.integer, !transfer.integer) -> i1
    %6 = "func.call"(%2, %0) <{callee = @shifting_amount_less_bitwidth}> : (!transfer.integer, !transfer.integer) -> i1
    %7 = "transfer.sub"(%1, %4) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %8 = "func.call"(%1, %4) <{callee = @sub_nsw}> : (!transfer.integer, !transfer.integer) -> i1
