module {
  ...
  func.func @op_constraint(%arg0: !transfer.integer, %arg1: !transfer.integer, %arg2: !transfer.integer) -> i1 {
    %0 = "transfer.ashr"(%arg2, %arg0) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %0_constraint_0 = func.call @ashr_exact(%arg2, %arg0) : (!transfer.integer, !transfer.integer) -> i1
    %0_constraint_1 = func.call @shifting_amount_less_bitwidth(%arg2, %arg0) : (!transfer.integer, !transfer.integer) -> i1
    %1_constraint_0 = func.call @sub_nsw(%arg1, %0) : (!transfer.integer, !transfer.integer) -> i1
