module {
  ...
  func.func @op_constraint(%arg0: !transfer.integer, %arg1: !transfer.integer) -> i1 {
    ...
    %0 = "transfer.shl"(%arg1, %arg0) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %1 = call @shl_nuw(%arg1, %arg0) : (!transfer.integer, !transfer.integer) -> i1
    %2 = call @shl_nsw(%arg1, %arg0) : (!transfer.integer, !transfer.integer) -> i1
    %3 = call @shifting_amount_less_bitwidth(%arg1, %arg0) : (!transfer.integer, !transfer.integer) -> i1
    %4 = "transfer.or"(%arg0, %0) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %5 = call @or_disjoint(%arg0, %0) : (!transfer.integer, !transfer.integer) -> i1
