module {
  func.func @concrete_op(%arg0: !transfer.integer, %arg1: !transfer.integer, %arg2: !transfer.integer) -> !transfer.integer {
    ...
    %4 = "transfer.or"(%arg1, %3) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    return %4 : !transfer.integer
  }
  func.func @op_constraint(%arg0: !transfer.integer, %arg1: !transfer.integer, %arg2: !transfer.integer) -> i1 {
    %0 = "transfer.lshr"(%arg2, %arg1) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %0_constraint_0 = func.call @shifting_amount_less_bitwidth(%arg2, %arg1) : (!transfer.integer, !transfer.integer) -> i1
    %1 = "transfer.lshr"(%arg0, %arg1) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %1_constraint_0 = func.call @shifting_amount_less_bitwidth(%arg0, %arg1) : (!transfer.integer, !transfer.integer) -> i1
    %2 = "transfer.add"(%0, %1) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %2_constraint_0 = func.call @add_nuw(%0, %1) : (!transfer.integer, !transfer.integer) -> i1
    %3 = "transfer.shl"(%2, %arg1) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %3_constraint_0 = func.call @shl_nuw(%2, %arg1) : (!transfer.integer, !transfer.integer) -> i1
    %3_constraint_1 = func.call @shifting_amount_less_bitwidth(%2, %arg1) : (!transfer.integer, !transfer.integer) -> i1
    %4_constraint_0 = func.call @or_disjoint(%arg1, %3) : (!transfer.integer, !transfer.integer) -> i1
    %and_0 = arith.andi %0_constraint_0, %1_constraint_0 : i1
    %and_1 = arith.andi %and_0, %2_constraint_0 : i1
    %and_2 = arith.andi %and_1, %3_constraint_0 : i1
    %and_3 = arith.andi %and_2, %3_constraint_1 : i1
    %and_4 = arith.andi %and_3, %4_constraint_0 : i1
    return %and_4 : i1
  }
