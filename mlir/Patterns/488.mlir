"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer, %4 : !transfer.integer):
    %5 = "transfer.or"(%2, %4) : (!transfer.integer, !transfer.integer) -> !transfer.integer
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer, %4 : !transfer.integer):
    ...
    %6 = "transfer.or"(%2, %4) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %7 = "transfer.lshr"(%1, %3) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %8 = "func.call"(%1, %3) <{callee = @shifting_amount_less_bitwidth}> : (!transfer.integer, !transfer.integer) -> i1
    %9 = "transfer.or"(%6, %7) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %10 = "transfer.lshr"(%9, %0) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %11 = "func.call"(%9, %0) <{callee = @shifting_amount_less_bitwidth}> : (!transfer.integer, !transfer.integer) -> i1
