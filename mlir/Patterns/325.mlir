"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer):
    ...
    %6 = "transfer.shl"(%1, %0) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %7 = "func.call"(%1, %0) <{callee = @shl_nuw}> : (!transfer.integer, !transfer.integer) -> i1
    %8 = "func.call"(%1, %0) <{callee = @shl_nsw}> : (!transfer.integer, !transfer.integer) -> i1
