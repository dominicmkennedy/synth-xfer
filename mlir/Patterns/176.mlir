module {
  func.func @concrete_op(%arg0: !transfer.integer, %arg1: !transfer.integer, %arg2: !transfer.integer, %arg3: !transfer.integer, %arg4: !transfer.integer) -> !transfer.integer {
    ...
    %1 = "transfer.lshr"(%arg2, %arg1) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %2 = "transfer.lshr"(%arg2, %arg0) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %3 = "transfer.xor"(%1, %2) : (!transfer.integer, !transfer.integer) -> !transfer.integer
  ...
  func.func @op_constraint(%arg0: !transfer.integer, %arg1: !transfer.integer, %arg2: !transfer.integer, %arg3: !transfer.integer, %arg4: !transfer.integer) -> i1 {
    %1_constraint_0 = func.call @shifting_amount_less_bitwidth(%arg2, %arg1) : (!transfer.integer, !transfer.integer) -> i1
    %2_constraint_0 = func.call @shifting_amount_less_bitwidth(%arg2, %arg0) : (!transfer.integer, !transfer.integer) -> i1
    %and_0 = arith.andi %1_constraint_0, %2_constraint_0 : i1
    return %and_0 : i1
  }
