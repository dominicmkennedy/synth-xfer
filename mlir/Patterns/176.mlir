module {
  ...
  func.func @op_constraint(%arg0: !transfer.integer, %arg1: !transfer.integer, %arg2: !transfer.integer, %arg3: !transfer.integer, %arg4: !transfer.integer) -> i1 {
    %constraint_1_0 = func.call @shifting_amount_less_bitwidth(%arg2, %arg1) : (!transfer.integer, !transfer.integer) -> i1
    %constraint_2_0 = func.call @shifting_amount_less_bitwidth(%arg2, %arg0) : (!transfer.integer, !transfer.integer) -> i1
