module {
  func.func @concrete_op(%arg0: !transfer.integer, %arg1: !transfer.integer) -> !transfer.integer {
    ...
    %1 = "transfer.sub"(%arg1, %0) : (!transfer.integer, !transfer.integer) -> !transfer.integer
  ...
  func.func @op_constraint(%arg0: !transfer.integer, %arg1: !transfer.integer) -> i1 {
    ...
    %2 = "transfer.sub"(%arg1, %0) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %3 = call @sub_nsw(%arg1, %0) : (!transfer.integer, !transfer.integer) -> i1
