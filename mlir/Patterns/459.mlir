module {
  ...
  func.func @op_constraint(%arg0: !transfer.integer, %arg1: !transfer.integer, %arg2: !transfer.integer, %arg3: !transfer.integer, %arg4: !transfer.integer, %arg5: !transfer.integer) -> i1 {
    %0 = "transfer.lshr"(%arg5, %arg4) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %0_constraint_0 = func.call @shifting_amount_less_bitwidth(%arg5, %arg4) : (!transfer.integer, !transfer.integer) -> i1
    %1 = "transfer.and"(%arg3, %0) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %2 = "transfer.or"(%arg2, %1) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %2_constraint_0 = func.call @or_disjoint(%arg2, %1) : (!transfer.integer, !transfer.integer) -> i1
    %3 = "transfer.lshr"(%arg1, %arg0) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %3_constraint_0 = func.call @shifting_amount_less_bitwidth(%arg1, %arg0) : (!transfer.integer, !transfer.integer) -> i1
    %4_constraint_0 = func.call @or_disjoint(%2, %3) : (!transfer.integer, !transfer.integer) -> i1
    %and_0 = arith.andi %0_constraint_0, %2_constraint_0 : i1
    %and_1 = arith.andi %and_0, %3_constraint_0 : i1
    %and_2 = arith.andi %and_1, %4_constraint_0 : i1
    return %and_2 : i1
  }
