module {
  ...
  func.func @op_constraint(%arg0: !transfer.integer, %arg1: !transfer.integer, %arg2: !transfer.integer, %arg3: !transfer.integer, %arg4: !transfer.integer) -> i1 {
    ...
    %1 = "transfer.or"(%arg4, %0) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %2 = "transfer.lshr"(%1, %arg1) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %constraint_2_0 = func.call @shifting_amount_less_bitwidth(%1, %arg1) : (!transfer.integer, !transfer.integer) -> i1
    %3 = "transfer.or"(%arg0, %2) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %constraint_4_0 = func.call @shifting_amount_less_bitwidth(%3, %arg3) : (!transfer.integer, !transfer.integer) -> i1
