module {
  ...
  func.func @op_constraint(%arg0: !transfer.integer, %arg1: !transfer.integer, %arg2: !transfer.integer, %arg3: !transfer.integer) -> i1 {
    ...
    %constraint_1_1 = func.call @shl_nsw(%arg1, %0) : (!transfer.integer, !transfer.integer) -> i1
    %constraint_1_2 = func.call @shifting_amount_less_bitwidth(%arg1, %0) : (!transfer.integer, !transfer.integer) -> i1
