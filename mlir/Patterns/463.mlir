module {
  ...
  func.func @op_constraint(%arg0: !transfer.integer, %arg1: !transfer.integer, %arg2: !transfer.integer) -> i1 {
    %0 = "transfer.add"(%arg1, %arg2) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %0_constraint_0 = func.call @add_nuw(%arg1, %arg2) : (!transfer.integer, !transfer.integer) -> i1
    %0_constraint_1 = func.call @add_nsw(%arg1, %arg2) : (!transfer.integer, !transfer.integer) -> i1
    ...
    %and_3 = arith.andi %and_2, %1_constraint_2 : i1
    return %and_3 : i1
  }
