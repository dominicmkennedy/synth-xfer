"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer, %4 : !transfer.integer, %5 : !transfer.integer):
    ...
    %7 = "transfer.shl"(%3, %2) : (!transfer.integer, !transfer.integer) -> !transfer.integer
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer, %4 : !transfer.integer, %5 : !transfer.integer):
    ...
    %11 = "transfer.shl"(%3, %2) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %12 = "func.call"(%3, %2) <{callee = @shl_nuw}> : (!transfer.integer, !transfer.integer) -> i1
    %13 = "func.call"(%3, %2) <{callee = @shl_nsw}> : (!transfer.integer, !transfer.integer) -> i1
    %14 = "func.call"(%3, %2) <{callee = @shifting_amount_less_bitwidth}> : (!transfer.integer, !transfer.integer) -> i1
