module {
  ...
  func.func @op_constraint(%arg0: !transfer.integer, %arg1: !transfer.integer, %arg2: !transfer.integer, %arg3: !transfer.integer, %arg4: !transfer.integer, %arg5: !transfer.integer) -> i1 {
    ...
    %constraint_0_2 = func.call @shifting_amount_less_bitwidth(%arg5, %arg4) : (!transfer.integer, !transfer.integer) -> i1
    %1 = "transfer.shl"(%arg3, %arg2) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %constraint_1_0 = func.call @shl_nuw(%arg3, %arg2) : (!transfer.integer, !transfer.integer) -> i1
    %constraint_1_1 = func.call @shl_nsw(%arg3, %arg2) : (!transfer.integer, !transfer.integer) -> i1
    %constraint_1_2 = func.call @shifting_amount_less_bitwidth(%arg3, %arg2) : (!transfer.integer, !transfer.integer) -> i1
    %2 = "transfer.or"(%arg1, %1) : (!transfer.integer, !transfer.integer) -> !transfer.integer
