module {
  ...
  func.func @op_constraint(%arg0: !transfer.integer, %arg1: !transfer.integer, %arg2: !transfer.integer, %arg3: !transfer.integer, %arg4: !transfer.integer, %arg5: !transfer.integer) -> i1 {
    ...
    %4 = "transfer.shl"(%arg3, %arg2) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %5 = call @shl_nuw(%arg3, %arg2) : (!transfer.integer, !transfer.integer) -> i1
    %6 = call @shl_nsw(%arg3, %arg2) : (!transfer.integer, !transfer.integer) -> i1
    %7 = call @shifting_amount_less_bitwidth(%arg3, %arg2) : (!transfer.integer, !transfer.integer) -> i1
    %8 = "transfer.or"(%arg1, %4) : (!transfer.integer, !transfer.integer) -> !transfer.integer
