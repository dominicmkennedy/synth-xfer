module {
  func.func @concrete_op(%arg0: !transfer.integer, %arg1: !transfer.integer, %arg2: !transfer.integer, %arg3: !transfer.integer) -> !transfer.integer {
    %0 = "transfer.lshr"(%arg3, %arg1) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    ...
    %3 = "transfer.lshr"(%2, %arg2) : (!transfer.integer, !transfer.integer) -> !transfer.integer
  ...
  func.func @op_constraint(%arg0: !transfer.integer, %arg1: !transfer.integer, %arg2: !transfer.integer, %arg3: !transfer.integer) -> i1 {
    %0 = "transfer.lshr"(%arg3, %arg1) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %0_constraint_0 = func.call @shifting_amount_less_bitwidth(%arg3, %arg1) : (!transfer.integer, !transfer.integer) -> i1
    %1 = "transfer.or"(%arg3, %0) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %2 = "transfer.or"(%arg0, %1) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %3_constraint_0 = func.call @shifting_amount_less_bitwidth(%2, %arg2) : (!transfer.integer, !transfer.integer) -> i1
    %and_0 = arith.andi %0_constraint_0, %3_constraint_0 : i1
    return %and_0 : i1
  }
