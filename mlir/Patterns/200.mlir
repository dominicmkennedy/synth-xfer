module {
  ...
  func.func @op_constraint(%arg0: !transfer.integer, %arg1: !transfer.integer, %arg2: !transfer.integer) -> i1 {
    %0 = "transfer.sdiv"(%arg2, %arg0) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %constraint_0_0 = func.call @sdiv_exact(%arg2, %arg0) : (!transfer.integer, !transfer.integer) -> i1
    %constraint_0_1 = func.call @rhs_neq_zero(%arg2, %arg0) : (!transfer.integer, !transfer.integer) -> i1
    %constraint_0_2 = func.call @no_sdiv_ov(%arg2, %arg0) : (!transfer.integer, !transfer.integer) -> i1
    %constraint_1_0 = func.call @add_nsw(%arg1, %0) : (!transfer.integer, !transfer.integer) -> i1
