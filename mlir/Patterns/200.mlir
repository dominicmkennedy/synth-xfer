module {
  ...
  func.func @op_constraint(%arg0: !transfer.integer, %arg1: !transfer.integer, %arg2: !transfer.integer) -> i1 {
    %0 = "transfer.sdiv"(%arg2, %arg0) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %ssa_0_con_0_z = func.call @sdiv_exact(%arg2, %arg0) : (!transfer.integer, !transfer.integer) -> i1
    %ssa_0_con_1_z = func.call @rhs_neq_zero(%arg2, %arg0) : (!transfer.integer, !transfer.integer) -> i1
    %ssa_0_con_2_z = func.call @no_sdiv_ov(%arg2, %arg0) : (!transfer.integer, !transfer.integer) -> i1
    %ssa_1_con_0_z = func.call @add_nsw(%arg1, %0) : (!transfer.integer, !transfer.integer) -> i1
