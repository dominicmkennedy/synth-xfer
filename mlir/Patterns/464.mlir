module {
  ...
  func.func @op_constraint(%arg0: !transfer.integer, %arg1: !transfer.integer, %arg2: !transfer.integer) -> i1 {
    %0 = "transfer.lshr"(%arg2, %arg0) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %constraint_0_0 = func.call @shifting_amount_less_bitwidth(%arg2, %arg0) : (!transfer.integer, !transfer.integer) -> i1
    %1 = "transfer.add"(%arg1, %0) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %constraint_1_0 = func.call @add_nuw(%arg1, %0) : (!transfer.integer, !transfer.integer) -> i1
    %constraint_2_0 = func.call @shl_nuw(%1, %arg0) : (!transfer.integer, !transfer.integer) -> i1
    %constraint_2_1 = func.call @shifting_amount_less_bitwidth(%1, %arg0) : (!transfer.integer, !transfer.integer) -> i1
