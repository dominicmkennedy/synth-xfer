module {
  ...
  func.func @op_constraint(%arg0: !transfer.integer, %arg1: !transfer.integer, %arg2: !transfer.integer, %arg3: !transfer.integer) -> i1 {
    ...
    %constraint_0_1 = func.call @add_nsw(%arg2, %arg3) : (!transfer.integer, !transfer.integer) -> i1
    %1 = "transfer.lshr"(%0, %arg1) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %constraint_1_0 = func.call @shifting_amount_less_bitwidth(%0, %arg1) : (!transfer.integer, !transfer.integer) -> i1
    %constraint_2_0 = func.call @add_nuw(%arg0, %1) : (!transfer.integer, !transfer.integer) -> i1
    %constraint_2_1 = func.call @add_nsw(%arg0, %1) : (!transfer.integer, !transfer.integer) -> i1
    ...
    %and_3 = arith.andi %and_2, %constraint_2_1 : i1
    return %and_3 : i1
  }
