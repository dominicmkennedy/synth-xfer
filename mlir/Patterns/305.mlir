"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer, %4 : !transfer.integer):
    ...
    %7 = "transfer.sub"(%1, %0) : (!transfer.integer, !transfer.integer) -> !transfer.integer
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer, %4 : !transfer.integer):
    ...
    %10 = "transfer.sub"(%1, %0) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %11 = "transfer.and"(%8, %10) : (!transfer.integer, !transfer.integer) -> !transfer.integer
