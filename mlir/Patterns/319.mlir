"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer, %4 : !transfer.integer):
    ...
    %7 = "transfer.shl"(%2, %6) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %8 = "func.call"(%2, %6) <{callee = @shl_nuw}> : (!transfer.integer, !transfer.integer) -> i1
    %9 = "func.call"(%2, %6) <{callee = @shifting_amount_less_bitwidth}> : (!transfer.integer, !transfer.integer) -> i1
    %10 = "transfer.xor"(%1, %7) : (!transfer.integer, !transfer.integer) -> !transfer.integer
