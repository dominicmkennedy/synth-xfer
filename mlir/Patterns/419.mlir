"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer, %4 : !transfer.integer, %5 : !transfer.integer):
    ...
    %7 = "transfer.or"(%1, %3) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %8 = "transfer.lshr"(%2, %0) : (!transfer.integer, !transfer.integer) -> !transfer.integer
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer, %4 : !transfer.integer, %5 : !transfer.integer):
    ...
    %9 = "transfer.or"(%1, %3) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %10 = "transfer.lshr"(%2, %0) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %11 = "func.call"(%2, %0) <{callee = @shifting_amount_less_bitwidth}> : (!transfer.integer, !transfer.integer) -> i1
    %12 = "transfer.or"(%9, %10) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %13 = "transfer.or"(%7, %12) : (!transfer.integer, !transfer.integer) -> !transfer.integer
