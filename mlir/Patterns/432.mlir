module {
  ...
  func.func @op_constraint(%arg0: !transfer.integer, %arg1: !transfer.integer, %arg2: !transfer.integer, %arg3: !transfer.integer, %arg4: !transfer.integer, %arg5: !transfer.integer) -> i1 {
    ...
    %0 = "transfer.add"(%arg4, %arg5) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %1 = "transfer.mul"(%arg3, %0) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %2 = call @mul_nuw(%arg3, %0) : (!transfer.integer, !transfer.integer) -> i1
    %3 = "transfer.add"(%arg1, %arg2) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %4 = "transfer.add"(%1, %3) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %5 = call @add_nuw(%1, %3) : (!transfer.integer, !transfer.integer) -> i1
    %6 = "transfer.and"(%arg0, %4) : (!transfer.integer, !transfer.integer) -> !transfer.integer
