module {
  ...
  func.func @op_constraint(%arg0: !transfer.integer, %arg1: !transfer.integer, %arg2: !transfer.integer) -> i1 {
    %0 = "transfer.sdiv"(%arg2, %arg1) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %constraint_0_0 = func.call @sdiv_exact(%arg2, %arg1) : (!transfer.integer, !transfer.integer) -> i1
    %constraint_0_1 = func.call @rhs_neq_zero(%arg2, %arg1) : (!transfer.integer, !transfer.integer) -> i1
    %constraint_0_2 = func.call @no_sdiv_ov(%arg2, %arg1) : (!transfer.integer, !transfer.integer) -> i1
    %constraint_1_0 = func.call @add_nsw(%arg0, %0) : (!transfer.integer, !transfer.integer) -> i1
    %and_0 = arith.andi %constraint_0_0, %constraint_0_1 : i1
    %and_1 = arith.andi %and_0, %constraint_1_0 : i1
    %and_2 = arith.andi %and_1, %constraint_0_2 : i1
    return %and_2 : i1
  }
