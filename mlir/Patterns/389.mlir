"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer):
    ...
    %7 = "transfer.or"(%0, %3) : (!transfer.integer, !transfer.integer) -> !transfer.integer
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer):
    ...
    %8 = "transfer.lshr"(%7, %1) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %9 = "func.call"(%7, %1) <{callee = @shifting_amount_less_bitwidth}> : (!transfer.integer, !transfer.integer) -> i1
    %10 = "transfer.or"(%0, %3) : (!transfer.integer, !transfer.integer) -> !transfer.integer
