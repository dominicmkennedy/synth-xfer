"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer):
    ...
    %5 = "transfer.ashr"(%4, %1) : (!transfer.integer, !transfer.integer) -> !transfer.integer
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer):
    ...
    %7 = "transfer.ashr"(%6, %1) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %8 = "func.call"(%6, %1) <{callee = @ashr_exact}> : (!transfer.integer, !transfer.integer) -> i1
    %9 = "func.call"(%6, %1) <{callee = @shifting_amount_less_bitwidth}> : (!transfer.integer, !transfer.integer) -> i1
