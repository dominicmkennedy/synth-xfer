module {
  ...
  func.func @op_constraint(%arg0: !transfer.integer, %arg1: !transfer.integer) -> i1 {
    %0 = "transfer.lshr"(%arg1, %arg0) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %0_constraint_0 = func.call @shifting_amount_less_bitwidth(%arg1, %arg0) : (!transfer.integer, !transfer.integer) -> i1
    %1 = "transfer.add"(%arg0, %0) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %1_constraint_0 = func.call @add_nuw(%arg0, %0) : (!transfer.integer, !transfer.integer) -> i1
    %2 = "transfer.shl"(%1, %arg0) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %2_constraint_0 = func.call @shl_nuw(%1, %arg0) : (!transfer.integer, !transfer.integer) -> i1
    %2_constraint_1 = func.call @shifting_amount_less_bitwidth(%1, %arg0) : (!transfer.integer, !transfer.integer) -> i1
