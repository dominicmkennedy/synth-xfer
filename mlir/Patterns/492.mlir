module {
  ...
  func.func @op_constraint(%arg0: !transfer.integer, %arg1: !transfer.integer, %arg2: !transfer.integer, %arg3: !transfer.integer, %arg4: !transfer.integer, %arg5: !transfer.integer) -> i1 {
    ...
    %5 = "transfer.lshr"(%4, %arg1) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %6 = call @shifting_amount_less_bitwidth(%4, %arg1) : (!transfer.integer, !transfer.integer) -> i1
