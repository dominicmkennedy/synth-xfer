module {
  ...
  func.func @op_constraint(%arg0: !transfer.integer, %arg1: !transfer.integer, %arg2: !transfer.integer) -> i1 {
    ...
    %1_constraint_0 = func.call @mul_nuw(%arg0, %0) : (!transfer.integer, !transfer.integer) -> i1
    %1_constraint_1 = func.call @mul_nsw(%arg0, %0) : (!transfer.integer, !transfer.integer) -> i1
