module {
  ...
  func.func @op_constraint(%arg0: !transfer.integer, %arg1: !transfer.integer, %arg2: !transfer.integer, %arg3: !transfer.integer) -> i1 {
    ...
    %0 = "transfer.xor"(%arg2, %arg3) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %1 = "transfer.mul"(%arg1, %0) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %2 = call @mul_nuw(%arg1, %0) : (!transfer.integer, !transfer.integer) -> i1
    %3 = call @mul_nsw(%arg1, %0) : (!transfer.integer, !transfer.integer) -> i1
    %4 = "transfer.add"(%arg0, %1) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %5 = call @add_nuw(%arg0, %1) : (!transfer.integer, !transfer.integer) -> i1
    %6 = call @add_nsw(%arg0, %1) : (!transfer.integer, !transfer.integer) -> i1
