"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer, %4 : !transfer.integer):
    ...
    %7 = "func.call"(%3, %4) <{callee = @mul_nsw}> : (!transfer.integer, !transfer.integer) -> i1
    ...
    %11 = "func.call"(%1, %8) <{callee = @add_nsw}> : (!transfer.integer, !transfer.integer) -> i1
    %12 = "transfer.sub"(%0, %10) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %13 = "func.call"(%0, %10) <{callee = @sub_nsw}> : (!transfer.integer, !transfer.integer) -> i1
