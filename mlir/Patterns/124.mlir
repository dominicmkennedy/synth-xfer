module {
  ...
  func.func @op_constraint(%arg0: !transfer.integer, %arg1: !transfer.integer) -> i1 {
    %constraint_0_0 = func.call @shl_nsw(%arg1, %arg0) : (!transfer.integer, !transfer.integer) -> i1
    %constraint_0_1 = func.call @shifting_amount_less_bitwidth(%arg1, %arg0) : (!transfer.integer, !transfer.integer) -> i1
