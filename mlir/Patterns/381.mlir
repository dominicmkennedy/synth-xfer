module {
  ...
  func.func @op_constraint(%arg0: !transfer.integer, %arg1: !transfer.integer, %arg2: !transfer.integer, %arg3: !transfer.integer, %arg4: !transfer.integer) -> i1 {
    %0 = "transfer.shl"(%arg4, %arg3) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %ssa_0_con_0_z = func.call @shl_nuw(%arg4, %arg3) : (!transfer.integer, !transfer.integer) -> i1
    %ssa_0_con_1_z = func.call @shl_nsw(%arg4, %arg3) : (!transfer.integer, !transfer.integer) -> i1
    %ssa_0_con_2_z = func.call @shift_lt_bw(%arg4, %arg3) : (!transfer.integer, !transfer.integer) -> i1
    %1 = "transfer.shl"(%arg2, %arg1) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %ssa_1_con_0_z = func.call @shl_nuw(%arg2, %arg1) : (!transfer.integer, !transfer.integer) -> i1
    %ssa_1_con_1_z = func.call @shl_nsw(%arg2, %arg1) : (!transfer.integer, !transfer.integer) -> i1
    %ssa_1_con_2_z = func.call @shift_lt_bw(%arg2, %arg1) : (!transfer.integer, !transfer.integer) -> i1
    %2 = "transfer.or"(%0, %1) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %ssa_2_con_0_z = func.call @or_disjoint(%0, %1) : (!transfer.integer, !transfer.integer) -> i1
