"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer):
    %4 = "transfer.shl"(%3, %2) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %5 = "transfer.shl"(%1, %0) : (!transfer.integer, !transfer.integer) -> !transfer.integer
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer):
    ...
    %5 = "transfer.shl"(%3, %2) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %6 = "func.call"(%3, %2) <{callee = @shl_nuw}> : (!transfer.integer, !transfer.integer) -> i1
    %7 = "func.call"(%3, %2) <{callee = @shl_nsw}> : (!transfer.integer, !transfer.integer) -> i1
    %8 = "func.call"(%3, %2) <{callee = @shifting_amount_less_bitwidth}> : (!transfer.integer, !transfer.integer) -> i1
    %9 = "transfer.shl"(%1, %0) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %10 = "func.call"(%1, %0) <{callee = @shl_nuw}> : (!transfer.integer, !transfer.integer) -> i1
    %11 = "func.call"(%1, %0) <{callee = @shl_nsw}> : (!transfer.integer, !transfer.integer) -> i1
