module {
  ...
  func.func @op_constraint(%arg0: !transfer.integer, %arg1: !transfer.integer, %arg2: !transfer.integer, %arg3: !transfer.integer) -> i1 {
    ...
    %4 = "transfer.or"(%arg1, %0) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %5 = call @or_disjoint(%arg1, %0) : (!transfer.integer, !transfer.integer) -> i1
    %6 = "transfer.or"(%arg0, %4) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %7 = call @or_disjoint(%arg0, %4) : (!transfer.integer, !transfer.integer) -> i1
