"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer):
    ...
    %7 = "func.call"(%0, %1) <{callee = @add_nuw}> : (!transfer.integer, !transfer.integer) -> i1
    %8 = "transfer.and"(%5, %6) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %9 = "transfer.sub"(%3, %8) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %10 = "func.call"(%3, %8) <{callee = @sub_nsw}> : (!transfer.integer, !transfer.integer) -> i1
