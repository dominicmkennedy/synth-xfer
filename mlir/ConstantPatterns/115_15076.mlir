"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer, %4 : !transfer.integer):
    ...
    %8 = "transfer.xor"(%1, %6) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %9 = "transfer.add"(%4, %0) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %10 = "transfer.and"(%8, %9) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %11 = "arith.andi"(%5, %7) : (i1, i1) -> i1
    "func.return"(%11) : (i1) -> ()
  }) : () -> ()
