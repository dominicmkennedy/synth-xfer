"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer):
    %4 = "transfer.mul"(%3, %2) : (!transfer.integer, !transfer.integer) -> !transfer.integer
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer):
    %4 = "arith.constant"() <{value = true}> : () -> i1
    %5 = "transfer.mul"(%3, %2) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %6 = "func.call"(%3, %2) <{callee = @mul_nsw}> : (!transfer.integer, !transfer.integer) -> i1
