"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer):
    ...
    %9 = "transfer.or"(%0, %5) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %10 = "func.call"(%0, %5) <{callee = @or_disjoint}> : (!transfer.integer, !transfer.integer) -> i1
    %11 = "transfer.or"(%3, %9) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %12 = "func.call"(%3, %9) <{callee = @or_disjoint}> : (!transfer.integer, !transfer.integer) -> i1
