"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer):
    ...
    %5 = "transfer.srem"(%0, %3) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %6 = "transfer.sub"(%4, %5) : (!transfer.integer, !transfer.integer) -> !transfer.integer
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer):
    ...
    %7 = "func.call"(%0, %3) <{callee = @rhs_neq_zero}> : (!transfer.integer, !transfer.integer) -> i1
    %8 = "transfer.sub"(%5, %6) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %9 = "func.call"(%5, %6) <{callee = @sub_nsw}> : (!transfer.integer, !transfer.integer) -> i1
