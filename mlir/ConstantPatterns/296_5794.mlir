"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer):
    ...
    %7 = "func.call"(%0, %3) <{callee = @shl_nuw}> : (!transfer.integer, !transfer.integer) -> i1
    %8 = "func.call"(%0, %3) <{callee = @shl_nsw}> : (!transfer.integer, !transfer.integer) -> i1
    %9 = "func.call"(%0, %3) <{callee = @shifting_amount_less_bitwidth}> : (!transfer.integer, !transfer.integer) -> i1
    %10 = "transfer.or"(%5, %6) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %11 = "func.call"(%5, %6) <{callee = @or_disjoint}> : (!transfer.integer, !transfer.integer) -> i1
