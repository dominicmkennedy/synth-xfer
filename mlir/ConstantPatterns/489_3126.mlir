"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer):
    ...
    %7 = "transfer.sdiv"(%5, %2) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %8 = "func.call"(%5, %2) <{callee = @rhs_neq_zero}> : (!transfer.integer, !transfer.integer) -> i1
    %9 = "transfer.shl"(%7, %3) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %10 = "func.call"(%7, %3) <{callee = @shl_nsw}> : (!transfer.integer, !transfer.integer) -> i1
