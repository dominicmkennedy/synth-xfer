"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer):
    %4 = "transfer.mul"(%2, %1) : (!transfer.integer, !transfer.integer) -> !transfer.integer
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer):
    ...
    %6 = "func.call"(%2, %1) <{callee = @mul_nuw}> : (!transfer.integer, !transfer.integer) -> i1
    %7 = "func.call"(%2, %1) <{callee = @mul_nsw}> : (!transfer.integer, !transfer.integer) -> i1
    %8 = "transfer.add"(%0, %5) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %9 = "func.call"(%0, %5) <{callee = @add_nuw}> : (!transfer.integer, !transfer.integer) -> i1
    %10 = "func.call"(%0, %5) <{callee = @add_nsw}> : (!transfer.integer, !transfer.integer) -> i1
