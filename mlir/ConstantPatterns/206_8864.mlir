"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer, %4 : !transfer.integer):
    %5 = "transfer.lshr"(%1, %2) : (!transfer.integer, !transfer.integer) -> !transfer.integer
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer, %4 : !transfer.integer):
    ...
    %7 = "func.call"(%1, %2) <{callee = @shifting_amount_less_bitwidth}> : (!transfer.integer, !transfer.integer) -> i1
    %8 = "transfer.add"(%0, %6) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %9 = "func.call"(%0, %6) <{callee = @add_nuw}> : (!transfer.integer, !transfer.integer) -> i1
