"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer):
    %4 = "arith.constant"() <{value = true}> : () -> i1
    %5 = "transfer.add"(%1, %2) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %6 = "func.call"(%1, %2) <{callee = @add_nuw}> : (!transfer.integer, !transfer.integer) -> i1
    %7 = "func.call"(%1, %2) <{callee = @add_nsw}> : (!transfer.integer, !transfer.integer) -> i1
