"builtin.module"() ({
  ...
  ^0(%0 : !transfer.abs_value<[!transfer.integer, !transfer.integer]>, %1 : !transfer.abs_value<[!transfer.integer, !transfer.integer]>, %2 : !transfer.abs_value<[!transfer.integer, !transfer.integer]>, %3 : !transfer.abs_value<[!transfer.integer, !transfer.integer]>, %4 : !transfer.abs_value<[!transfer.integer, !transfer.integer]>, %5 : !transfer.abs_value<[!transfer.integer, !transfer.integer]>):
    ...
    %7 = "func.call"(%2) <{callee = @constant_constraint}> : (!transfer.abs_value<[!transfer.integer, !transfer.integer]>) -> i1
    %8 = "func.call"(%3) <{callee = @constant_constraint}> : (!transfer.abs_value<[!transfer.integer, !transfer.integer]>) -> i1
    %9 = "func.call"(%4) <{callee = @constant_constraint}> : (!transfer.abs_value<[!transfer.integer, !transfer.integer]>) -> i1
    %10 = "func.call"(%5) <{callee = @constant_constraint}> : (!transfer.abs_value<[!transfer.integer, !transfer.integer]>) -> i1
    %11 = "arith.andi"(%6, %7) : (i1, i1) -> i1
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer, %4 : !transfer.integer, %5 : !transfer.integer):
    %6 = "transfer.lshr"(%1, %2) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %7 = "transfer.lshr"(%0, %3) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %8 = "transfer.add"(%6, %7) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %9 = "transfer.shl"(%8, %4) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %10 = "transfer.or"(%5, %9) : (!transfer.integer, !transfer.integer) -> !transfer.integer
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer, %4 : !transfer.integer, %5 : !transfer.integer):
    %6 = "arith.constant"() <{value = true}> : () -> i1
    %7 = "transfer.lshr"(%1, %2) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %8 = "func.call"(%1, %2) <{callee = @shifting_amount_less_bitwidth}> : (!transfer.integer, !transfer.integer) -> i1
    %9 = "transfer.lshr"(%0, %3) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %10 = "func.call"(%0, %3) <{callee = @shifting_amount_less_bitwidth}> : (!transfer.integer, !transfer.integer) -> i1
    %11 = "transfer.add"(%7, %9) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %12 = "func.call"(%7, %9) <{callee = @add_nuw}> : (!transfer.integer, !transfer.integer) -> i1
    %13 = "transfer.shl"(%11, %4) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %14 = "func.call"(%11, %4) <{callee = @shl_nuw}> : (!transfer.integer, !transfer.integer) -> i1
    %15 = "func.call"(%11, %4) <{callee = @shifting_amount_less_bitwidth}> : (!transfer.integer, !transfer.integer) -> i1
    %16 = "transfer.or"(%5, %13) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %17 = "func.call"(%5, %13) <{callee = @or_disjoint}> : (!transfer.integer, !transfer.integer) -> i1
    %18 = "arith.andi"(%6, %8) : (i1, i1) -> i1
    %19 = "arith.andi"(%18, %10) : (i1, i1) -> i1
    %20 = "arith.andi"(%19, %12) : (i1, i1) -> i1
    %21 = "arith.andi"(%20, %14) : (i1, i1) -> i1
    %22 = "arith.andi"(%21, %15) : (i1, i1) -> i1
    %23 = "arith.andi"(%22, %17) : (i1, i1) -> i1
    "func.return"(%23) : (i1) -> ()
  }) : () -> ()
