"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer, %4 : !transfer.integer, %5 : !transfer.integer):
    ...
    %8 = "transfer.and"(%5, %0) : (!transfer.integer, !transfer.integer) -> !transfer.integer
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer, %4 : !transfer.integer, %5 : !transfer.integer):
    ...
    %8 = "transfer.and"(%4, %1) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %9 = "transfer.and"(%5, %0) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %10 = "transfer.or"(%8, %9) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %11 = "func.call"(%8, %9) <{callee = @or_disjoint}> : (!transfer.integer, !transfer.integer) -> i1
    %12 = "transfer.or"(%7, %10) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %13 = "func.call"(%7, %10) <{callee = @or_disjoint}> : (!transfer.integer, !transfer.integer) -> i1
    %14 = "arith.andi"(%6, %11) : (i1, i1) -> i1
