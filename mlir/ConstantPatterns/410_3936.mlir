"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer):
    %4 = "arith.constant"() <{value = true}> : () -> i1
    %5 = "transfer.ashr"(%1, %2) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    ...
    %9 = "transfer.sub"(%3, %7) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %10 = "func.call"(%3, %7) <{callee = @sub_nsw}> : (!transfer.integer, !transfer.integer) -> i1
