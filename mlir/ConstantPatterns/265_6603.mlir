"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer, %4 : !transfer.integer):
    %5 = "transfer.lshr"(%0, %1) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    ...
    %8 = "transfer.or"(%4, %7) : (!transfer.integer, !transfer.integer) -> !transfer.integer
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer, %4 : !transfer.integer):
    ...
    %8 = "transfer.add"(%2, %6) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %9 = "func.call"(%2, %6) <{callee = @add_nuw}> : (!transfer.integer, !transfer.integer) -> i1
    %10 = "transfer.shl"(%8, %3) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %11 = "func.call"(%8, %3) <{callee = @shl_nuw}> : (!transfer.integer, !transfer.integer) -> i1
    %12 = "func.call"(%8, %3) <{callee = @shifting_amount_less_bitwidth}> : (!transfer.integer, !transfer.integer) -> i1
    %13 = "transfer.or"(%4, %10) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %14 = "func.call"(%4, %10) <{callee = @or_disjoint}> : (!transfer.integer, !transfer.integer) -> i1
    %15 = "arith.andi"(%5, %7) : (i1, i1) -> i1
