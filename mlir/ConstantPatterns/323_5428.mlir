"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer):
    %4 = "transfer.shl"(%1, %2) : (!transfer.integer, !transfer.integer) -> !transfer.integer
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer):
    %4 = "arith.constant"() <{value = true}> : () -> i1
    %5 = "transfer.shl"(%1, %2) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %6 = "func.call"(%1, %2) <{callee = @shl_nuw}> : (!transfer.integer, !transfer.integer) -> i1
    %7 = "func.call"(%1, %2) <{callee = @shl_nsw}> : (!transfer.integer, !transfer.integer) -> i1
    %8 = "func.call"(%1, %2) <{callee = @shifting_amount_less_bitwidth}> : (!transfer.integer, !transfer.integer) -> i1
    %9 = "transfer.shl"(%0, %3) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %10 = "func.call"(%0, %3) <{callee = @shl_nuw}> : (!transfer.integer, !transfer.integer) -> i1
    %11 = "func.call"(%0, %3) <{callee = @shl_nsw}> : (!transfer.integer, !transfer.integer) -> i1
    %12 = "func.call"(%0, %3) <{callee = @shifting_amount_less_bitwidth}> : (!transfer.integer, !transfer.integer) -> i1
    %13 = "transfer.or"(%5, %9) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %14 = "func.call"(%5, %9) <{callee = @or_disjoint}> : (!transfer.integer, !transfer.integer) -> i1
    %15 = "arith.andi"(%4, %6) : (i1, i1) -> i1
