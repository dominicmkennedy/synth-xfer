"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer, %4 : !transfer.integer, %5 : !transfer.integer):
    ...
    %8 = "transfer.lshr"(%7, %5) : (!transfer.integer, !transfer.integer) -> !transfer.integer
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer, %4 : !transfer.integer, %5 : !transfer.integer):
    ...
    %10 = "func.call"(%8, %5) <{callee = @shifting_amount_less_bitwidth}> : (!transfer.integer, !transfer.integer) -> i1
    %11 = "transfer.or"(%1, %9) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %12 = "transfer.or"(%0, %11) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %13 = "arith.andi"(%6, %10) : (i1, i1) -> i1
    "func.return"(%13) : (i1) -> ()
  }) : () -> ()
