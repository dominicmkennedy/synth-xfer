"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer, %4 : !transfer.integer):
    ...
    %6 = "transfer.shl"(%1, %4) : (!transfer.integer, !transfer.integer) -> !transfer.integer
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer, %4 : !transfer.integer):
    ...
    %10 = "transfer.shl"(%1, %4) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %11 = "func.call"(%1, %4) <{callee = @shl_nuw}> : (!transfer.integer, !transfer.integer) -> i1
    %12 = "func.call"(%1, %4) <{callee = @shl_nsw}> : (!transfer.integer, !transfer.integer) -> i1
    %13 = "func.call"(%1, %4) <{callee = @shifting_amount_less_bitwidth}> : (!transfer.integer, !transfer.integer) -> i1
    %14 = "transfer.or"(%0, %10) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %15 = "func.call"(%0, %10) <{callee = @or_disjoint}> : (!transfer.integer, !transfer.integer) -> i1
    %16 = "transfer.or"(%6, %14) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %17 = "func.call"(%6, %14) <{callee = @or_disjoint}> : (!transfer.integer, !transfer.integer) -> i1
