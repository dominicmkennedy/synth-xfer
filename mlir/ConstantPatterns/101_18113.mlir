"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer, %4 : !transfer.integer):
    ...
    %6 = "transfer.lshr"(%1, %4) : (!transfer.integer, !transfer.integer) -> !transfer.integer
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer, %4 : !transfer.integer):
    %5 = "arith.constant"() <{value = true}> : () -> i1
    %6 = "transfer.add"(%3, %2) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %7 = "transfer.lshr"(%1, %4) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %8 = "func.call"(%1, %4) <{callee = @shifting_amount_less_bitwidth}> : (!transfer.integer, !transfer.integer) -> i1
    %9 = "transfer.xor"(%0, %7) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %10 = "transfer.and"(%6, %9) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %11 = "arith.andi"(%5, %8) : (i1, i1) -> i1
    "func.return"(%11) : (i1) -> ()
  }) : () -> ()
