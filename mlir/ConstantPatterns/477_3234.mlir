"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer):
    ...
    %8 = "transfer.or"(%1, %5) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %9 = "func.call"(%1, %5) <{callee = @or_disjoint}> : (!transfer.integer, !transfer.integer) -> i1
    %10 = "transfer.or"(%0, %8) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %11 = "func.call"(%0, %8) <{callee = @or_disjoint}> : (!transfer.integer, !transfer.integer) -> i1
