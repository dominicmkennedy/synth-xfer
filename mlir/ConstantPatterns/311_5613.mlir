"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer, %4 : !transfer.integer):
    %5 = "transfer.mul"(%1, %0) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    ...
    %8 = "transfer.add"(%4, %7) : (!transfer.integer, !transfer.integer) -> !transfer.integer
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer, %4 : !transfer.integer):
    %5 = "arith.constant"() <{value = true}> : () -> i1
    %6 = "transfer.mul"(%1, %0) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %7 = "func.call"(%1, %0) <{callee = @mul_nuw}> : (!transfer.integer, !transfer.integer) -> i1
    %8 = "func.call"(%1, %0) <{callee = @mul_nsw}> : (!transfer.integer, !transfer.integer) -> i1
    ...
    %12 = "transfer.lshr"(%9, %3) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %13 = "func.call"(%9, %3) <{callee = @shifting_amount_less_bitwidth}> : (!transfer.integer, !transfer.integer) -> i1
    %14 = "transfer.add"(%4, %12) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %15 = "func.call"(%4, %12) <{callee = @add_nuw}> : (!transfer.integer, !transfer.integer) -> i1
    %16 = "func.call"(%4, %12) <{callee = @add_nsw}> : (!transfer.integer, !transfer.integer) -> i1
