"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer):
    %3 = "transfer.srem"(%1, %2) : (!transfer.integer, !transfer.integer) -> !transfer.integer
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer):
    %3 = "arith.constant"() <{value = true}> : () -> i1
    %4 = "transfer.srem"(%1, %2) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %5 = "func.call"(%1, %2) <{callee = @rhs_neq_zero}> : (!transfer.integer, !transfer.integer) -> i1
    %6 = "transfer.sub"(%1, %4) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %7 = "func.call"(%1, %4) <{callee = @sub_nsw}> : (!transfer.integer, !transfer.integer) -> i1
    %8 = "transfer.sub"(%6, %0) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %9 = "func.call"(%6, %0) <{callee = @sub_nsw}> : (!transfer.integer, !transfer.integer) -> i1
