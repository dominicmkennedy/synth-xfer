"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer, %4 : !transfer.integer, %5 : !transfer.integer):
    ...
    %7 = "transfer.lshr"(%2, %5) : (!transfer.integer, !transfer.integer) -> !transfer.integer
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer, %4 : !transfer.integer, %5 : !transfer.integer):
    %6 = "arith.constant"() <{value = true}> : () -> i1
    %7 = "transfer.or"(%3, %4) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %8 = "transfer.lshr"(%2, %5) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %9 = "func.call"(%2, %5) <{callee = @shifting_amount_less_bitwidth}> : (!transfer.integer, !transfer.integer) -> i1
    %10 = "transfer.or"(%7, %8) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %11 = "transfer.or"(%1, %10) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %12 = "transfer.or"(%0, %11) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %13 = "arith.andi"(%6, %9) : (i1, i1) -> i1
    "func.return"(%13) : (i1) -> ()
  }) : () -> ()
