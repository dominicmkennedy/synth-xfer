"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer, %4 : !transfer.integer, %5 : !transfer.integer):
    ...
    %7 = "transfer.add"(%5, %2) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %8 = "transfer.mul"(%1, %7) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %9 = "transfer.add"(%0, %8) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %10 = "transfer.and"(%6, %9) : (!transfer.integer, !transfer.integer) -> !transfer.integer
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer, %4 : !transfer.integer, %5 : !transfer.integer):
    %6 = "arith.constant"() <{value = true}> : () -> i1
    %7 = "transfer.sub"(%4, %3) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %8 = "transfer.add"(%5, %2) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %9 = "transfer.mul"(%1, %8) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %10 = "func.call"(%1, %8) <{callee = @mul_nuw}> : (!transfer.integer, !transfer.integer) -> i1
    %11 = "transfer.add"(%0, %9) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %12 = "func.call"(%0, %9) <{callee = @add_nuw}> : (!transfer.integer, !transfer.integer) -> i1
    %13 = "transfer.and"(%7, %11) : (!transfer.integer, !transfer.integer) -> !transfer.integer
