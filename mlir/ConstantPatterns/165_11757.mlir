"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer):
    %4 = "transfer.and"(%3, %2) : (!transfer.integer, !transfer.integer) -> !transfer.integer
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer):
    ...
    %7 = "func.call"(%0, %1) <{callee = @or_disjoint}> : (!transfer.integer, !transfer.integer) -> i1
    %8 = "transfer.or"(%5, %6) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %9 = "func.call"(%5, %6) <{callee = @or_disjoint}> : (!transfer.integer, !transfer.integer) -> i1
