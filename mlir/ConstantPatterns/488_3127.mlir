"builtin.module"() ({
  ...
  ^0(%0 : !transfer.abs_value<[!transfer.integer, !transfer.integer]>, %1 : !transfer.abs_value<[!transfer.integer, !transfer.integer]>, %2 : !transfer.abs_value<[!transfer.integer, !transfer.integer]>, %3 : !transfer.abs_value<[!transfer.integer, !transfer.integer]>, %4 : !transfer.abs_value<[!transfer.integer, !transfer.integer]>, %5 : !transfer.abs_value<[!transfer.integer, !transfer.integer]>):
    ...
    %7 = "func.call"(%5) <{callee = @constant_constraint}> : (!transfer.abs_value<[!transfer.integer, !transfer.integer]>) -> i1
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer, %4 : !transfer.integer, %5 : !transfer.integer):
    %6 = "transfer.shl"(%4, %5) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %7 = "transfer.xor"(%3, %6) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %8 = "transfer.xor"(%1, %2) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %9 = "transfer.xor"(%0, %8) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %10 = "transfer.xor"(%7, %9) : (!transfer.integer, !transfer.integer) -> !transfer.integer
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer, %4 : !transfer.integer, %5 : !transfer.integer):
    %6 = "arith.constant"() <{value = true}> : () -> i1
    %7 = "transfer.shl"(%4, %5) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %8 = "func.call"(%4, %5) <{callee = @shl_nuw}> : (!transfer.integer, !transfer.integer) -> i1
    %9 = "func.call"(%4, %5) <{callee = @shl_nsw}> : (!transfer.integer, !transfer.integer) -> i1
    %10 = "func.call"(%4, %5) <{callee = @shifting_amount_less_bitwidth}> : (!transfer.integer, !transfer.integer) -> i1
    %11 = "transfer.xor"(%3, %7) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %12 = "transfer.xor"(%1, %2) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %13 = "transfer.xor"(%0, %12) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %14 = "transfer.xor"(%11, %13) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %15 = "arith.andi"(%6, %8) : (i1, i1) -> i1
    %16 = "arith.andi"(%15, %9) : (i1, i1) -> i1
    %17 = "arith.andi"(%16, %10) : (i1, i1) -> i1
    "func.return"(%17) : (i1) -> ()
  }) : () -> ()
