"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer, %4 : !transfer.integer, %5 : !transfer.integer):
    ...
    %7 = "transfer.add"(%1, %2) : (!transfer.integer, !transfer.integer) -> !transfer.integer
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer, %4 : !transfer.integer, %5 : !transfer.integer):
    ...
    %9 = "func.call"(%1, %2) <{callee = @add_nuw}> : (!transfer.integer, !transfer.integer) -> i1
    %10 = "transfer.and"(%7, %8) : (!transfer.integer, !transfer.integer) -> !transfer.integer
