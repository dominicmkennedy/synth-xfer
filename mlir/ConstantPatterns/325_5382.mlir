"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer, %4 : !transfer.integer, %5 : !transfer.integer):
    ...
    %7 = "transfer.shl"(%1, %4) : (!transfer.integer, !transfer.integer) -> !transfer.integer
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer, %4 : !transfer.integer, %5 : !transfer.integer):
    ...
    %8 = "transfer.shl"(%1, %4) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    ...
    %13 = "transfer.or"(%7, %11) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %14 = "func.call"(%7, %11) <{callee = @or_disjoint}> : (!transfer.integer, !transfer.integer) -> i1
