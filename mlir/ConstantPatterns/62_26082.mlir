"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer):
    %3 = "arith.constant"() <{value = true}> : () -> i1
    %4 = "transfer.urem"(%0, %1) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %5 = "func.call"(%0, %1) <{callee = @rhs_neq_zero}> : (!transfer.integer, !transfer.integer) -> i1
    %6 = "transfer.shl"(%4, %2) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %7 = "func.call"(%4, %2) <{callee = @shl_nuw}> : (!transfer.integer, !transfer.integer) -> i1
    %8 = "func.call"(%4, %2) <{callee = @shl_nsw}> : (!transfer.integer, !transfer.integer) -> i1
