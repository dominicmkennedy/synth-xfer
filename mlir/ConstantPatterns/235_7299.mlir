"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer, %4 : !transfer.integer):
    ...
    %6 = "transfer.add"(%3, %1) : (!transfer.integer, !transfer.integer) -> !transfer.integer
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer, %4 : !transfer.integer):
    %5 = "arith.constant"() <{value = true}> : () -> i1
    %6 = "transfer.sub"(%2, %1) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %7 = "transfer.add"(%3, %1) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %8 = "transfer.add"(%0, %7) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %9 = "func.call"(%0, %7) <{callee = @add_nuw}> : (!transfer.integer, !transfer.integer) -> i1
    %10 = "transfer.and"(%6, %8) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %11 = "transfer.sub"(%4, %10) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %12 = "func.call"(%4, %10) <{callee = @sub_nsw}> : (!transfer.integer, !transfer.integer) -> i1
