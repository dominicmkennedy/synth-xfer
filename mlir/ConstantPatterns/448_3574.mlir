"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer, %4 : !transfer.integer):
    %5 = "transfer.mul"(%2, %1) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %6 = "transfer.add"(%3, %5) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %7 = "transfer.lshr"(%6, %4) : (!transfer.integer, !transfer.integer) -> !transfer.integer
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer, %4 : !transfer.integer):
    %5 = "arith.constant"() <{value = true}> : () -> i1
    %6 = "transfer.mul"(%2, %1) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %7 = "func.call"(%2, %1) <{callee = @mul_nuw}> : (!transfer.integer, !transfer.integer) -> i1
    %8 = "func.call"(%2, %1) <{callee = @mul_nsw}> : (!transfer.integer, !transfer.integer) -> i1
    %9 = "transfer.add"(%3, %6) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %10 = "func.call"(%3, %6) <{callee = @add_nuw}> : (!transfer.integer, !transfer.integer) -> i1
    %11 = "func.call"(%3, %6) <{callee = @add_nsw}> : (!transfer.integer, !transfer.integer) -> i1
    %12 = "transfer.lshr"(%9, %4) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %13 = "func.call"(%9, %4) <{callee = @shifting_amount_less_bitwidth}> : (!transfer.integer, !transfer.integer) -> i1
    %14 = "transfer.add"(%0, %12) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %15 = "arith.andi"(%5, %7) : (i1, i1) -> i1
    %16 = "arith.andi"(%15, %8) : (i1, i1) -> i1
    %17 = "arith.andi"(%16, %10) : (i1, i1) -> i1
    %18 = "arith.andi"(%17, %11) : (i1, i1) -> i1
    %19 = "arith.andi"(%18, %13) : (i1, i1) -> i1
    "func.return"(%19) : (i1) -> ()
  }) : () -> ()
