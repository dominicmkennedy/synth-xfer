"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer):
    ...
    %5 = "transfer.ashr"(%4, %3) : (!transfer.integer, !transfer.integer) -> !transfer.integer
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer):
    ...
    %6 = "func.call"(%2, %1) <{callee = @mul_nsw}> : (!transfer.integer, !transfer.integer) -> i1
    %7 = "transfer.ashr"(%5, %3) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %8 = "func.call"(%5, %3) <{callee = @shifting_amount_less_bitwidth}> : (!transfer.integer, !transfer.integer) -> i1
