"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer):
    ...
    %5 = "func.call"(%2, %1) <{callee = @sub_nsw}> : (!transfer.integer, !transfer.integer) -> i1
    %6 = "transfer.lshr"(%0, %4) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %7 = "func.call"(%0, %4) <{callee = @shifting_amount_less_bitwidth}> : (!transfer.integer, !transfer.integer) -> i1
