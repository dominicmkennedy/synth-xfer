"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer, %4 : !transfer.integer, %5 : !transfer.integer):
    ...
    %8 = "transfer.add"(%2, %7) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %9 = "func.call"(%2, %7) <{callee = @add_nuw}> : (!transfer.integer, !transfer.integer) -> i1
    %10 = "transfer.and"(%1, %8) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %11 = "transfer.add"(%5, %0) : (!transfer.integer, !transfer.integer) -> !transfer.integer
