"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer):
    ...
    %5 = "transfer.sub"(%2, %4) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %6 = "func.call"(%2, %4) <{callee = @sub_nuw}> : (!transfer.integer, !transfer.integer) -> i1
    %7 = "func.call"(%2, %4) <{callee = @sub_nsw}> : (!transfer.integer, !transfer.integer) -> i1
