"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer, %4 : !transfer.integer):
    ...
    %7 = "transfer.or"(%0, %1) : (!transfer.integer, !transfer.integer) -> !transfer.integer
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer, %4 : !transfer.integer):
    ...
    %10 = "transfer.and"(%4, %6) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %11 = "transfer.or"(%0, %1) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %12 = "func.call"(%0, %1) <{callee = @or_disjoint}> : (!transfer.integer, !transfer.integer) -> i1
    %13 = "transfer.or"(%10, %11) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %14 = "func.call"(%10, %11) <{callee = @or_disjoint}> : (!transfer.integer, !transfer.integer) -> i1
