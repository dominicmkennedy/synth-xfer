"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer):
    %3 = "transfer.mul"(%0, %1) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %4 = "transfer.mul"(%0, %1) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %5 = "transfer.lshr"(%4, %2) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %6 = "transfer.xor"(%3, %5) : (!transfer.integer, !transfer.integer) -> !transfer.integer
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer):
    %3 = "arith.constant"() <{value = true}> : () -> i1
    %4 = "transfer.mul"(%0, %1) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %5 = "func.call"(%0, %1) <{callee = @mul_nuw}> : (!transfer.integer, !transfer.integer) -> i1
    %6 = "transfer.mul"(%0, %1) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %7 = "func.call"(%0, %1) <{callee = @mul_nuw}> : (!transfer.integer, !transfer.integer) -> i1
    %8 = "transfer.lshr"(%6, %2) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %9 = "func.call"(%6, %2) <{callee = @shifting_amount_less_bitwidth}> : (!transfer.integer, !transfer.integer) -> i1
    %10 = "transfer.xor"(%4, %8) : (!transfer.integer, !transfer.integer) -> !transfer.integer
