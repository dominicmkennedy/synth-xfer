"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer, %4 : !transfer.integer):
    ...
    %6 = "transfer.lshr"(%1, %3) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %7 = "transfer.xor"(%5, %6) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %8 = "transfer.add"(%4, %0) : (!transfer.integer, !transfer.integer) -> !transfer.integer
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer, %4 : !transfer.integer):
    ...
    %8 = "transfer.lshr"(%1, %3) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %9 = "func.call"(%1, %3) <{callee = @shifting_amount_less_bitwidth}> : (!transfer.integer, !transfer.integer) -> i1
    %10 = "transfer.xor"(%6, %8) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %11 = "transfer.add"(%4, %0) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %12 = "transfer.and"(%10, %11) : (!transfer.integer, !transfer.integer) -> !transfer.integer
