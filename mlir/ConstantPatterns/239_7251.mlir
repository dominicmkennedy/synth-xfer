"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer, %4 : !transfer.integer):
    ...
    %6 = "transfer.add"(%4, %2) : (!transfer.integer, !transfer.integer) -> !transfer.integer
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer, %4 : !transfer.integer):
    ...
    %8 = "transfer.add"(%1, %7) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %9 = "func.call"(%1, %7) <{callee = @add_nuw}> : (!transfer.integer, !transfer.integer) -> i1
    %10 = "transfer.and"(%6, %8) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %11 = "transfer.add"(%0, %10) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %12 = "func.call"(%0, %10) <{callee = @add_nuw}> : (!transfer.integer, !transfer.integer) -> i1
    %13 = "arith.andi"(%5, %9) : (i1, i1) -> i1
    %14 = "arith.andi"(%13, %12) : (i1, i1) -> i1
    "func.return"(%14) : (i1) -> ()
  }) : () -> ()
