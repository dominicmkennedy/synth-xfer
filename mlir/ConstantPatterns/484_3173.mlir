"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer):
    %4 = "transfer.add"(%3, %2) : (!transfer.integer, !transfer.integer) -> !transfer.integer
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer):
    %4 = "arith.constant"() <{value = true}> : () -> i1
    %5 = "transfer.add"(%3, %2) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %6 = "func.call"(%3, %2) <{callee = @add_nuw}> : (!transfer.integer, !transfer.integer) -> i1
    %7 = "func.call"(%3, %2) <{callee = @add_nsw}> : (!transfer.integer, !transfer.integer) -> i1
    %8 = "transfer.add"(%1, %5) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %9 = "func.call"(%1, %5) <{callee = @add_nuw}> : (!transfer.integer, !transfer.integer) -> i1
    %10 = "func.call"(%1, %5) <{callee = @add_nsw}> : (!transfer.integer, !transfer.integer) -> i1
    %11 = "transfer.add"(%0, %8) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %12 = "func.call"(%0, %8) <{callee = @add_nuw}> : (!transfer.integer, !transfer.integer) -> i1
    %13 = "func.call"(%0, %8) <{callee = @add_nsw}> : (!transfer.integer, !transfer.integer) -> i1
    %14 = "arith.andi"(%4, %6) : (i1, i1) -> i1
    %15 = "arith.andi"(%14, %7) : (i1, i1) -> i1
