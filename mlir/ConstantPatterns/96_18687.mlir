"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer):
    %3 = "transfer.and"(%2, %1) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %4 = "transfer.lshr"(%0, %3) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %5 = "transfer.sub"(%0, %4) : (!transfer.integer, !transfer.integer) -> !transfer.integer
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer):
    ...
    %5 = "transfer.lshr"(%0, %4) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %6 = "func.call"(%0, %4) <{callee = @shifting_amount_less_bitwidth}> : (!transfer.integer, !transfer.integer) -> i1
    %7 = "transfer.sub"(%0, %5) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %8 = "func.call"(%0, %5) <{callee = @sub_nsw}> : (!transfer.integer, !transfer.integer) -> i1
