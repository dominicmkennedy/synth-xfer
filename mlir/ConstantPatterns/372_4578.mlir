"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer, %4 : !transfer.integer, %5 : !transfer.integer):
    ...
    %7 = "transfer.add"(%4, %1) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %8 = "transfer.add"(%6, %7) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %9 = "transfer.and"(%0, %8) : (!transfer.integer, !transfer.integer) -> !transfer.integer
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer, %4 : !transfer.integer, %5 : !transfer.integer):
    %6 = "arith.constant"() <{value = true}> : () -> i1
    %7 = "transfer.mul"(%2, %3) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %8 = "func.call"(%2, %3) <{callee = @mul_nuw}> : (!transfer.integer, !transfer.integer) -> i1
    %9 = "transfer.add"(%4, %1) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %10 = "transfer.add"(%7, %9) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %11 = "func.call"(%7, %9) <{callee = @add_nuw}> : (!transfer.integer, !transfer.integer) -> i1
    %12 = "transfer.and"(%0, %10) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %13 = "transfer.sub"(%5, %12) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %14 = "func.call"(%5, %12) <{callee = @sub_nsw}> : (!transfer.integer, !transfer.integer) -> i1
