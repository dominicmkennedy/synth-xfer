"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer, %4 : !transfer.integer, %5 : !transfer.integer):
    ...
    %8 = "transfer.shl"(%1, %5) : (!transfer.integer, !transfer.integer) -> !transfer.integer
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer, %4 : !transfer.integer, %5 : !transfer.integer):
    ...
    %11 = "transfer.or"(%2, %7) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %12 = "func.call"(%2, %7) <{callee = @or_disjoint}> : (!transfer.integer, !transfer.integer) -> i1
    %13 = "transfer.shl"(%1, %5) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %14 = "func.call"(%1, %5) <{callee = @shl_nuw}> : (!transfer.integer, !transfer.integer) -> i1
    %15 = "func.call"(%1, %5) <{callee = @shl_nsw}> : (!transfer.integer, !transfer.integer) -> i1
    %16 = "func.call"(%1, %5) <{callee = @shifting_amount_less_bitwidth}> : (!transfer.integer, !transfer.integer) -> i1
