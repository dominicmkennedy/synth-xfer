"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer, %4 : !transfer.integer, %5 : !transfer.integer):
    %6 = "transfer.add"(%4, %3) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %7 = "transfer.mul"(%2, %6) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %8 = "transfer.add"(%5, %1) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %9 = "transfer.add"(%7, %8) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %10 = "transfer.and"(%0, %9) : (!transfer.integer, !transfer.integer) -> !transfer.integer
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer, %4 : !transfer.integer, %5 : !transfer.integer):
    %6 = "arith.constant"() <{value = true}> : () -> i1
    %7 = "transfer.add"(%4, %3) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %8 = "transfer.mul"(%2, %7) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %9 = "func.call"(%2, %7) <{callee = @mul_nuw}> : (!transfer.integer, !transfer.integer) -> i1
    %10 = "transfer.add"(%5, %1) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %11 = "transfer.add"(%8, %10) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %12 = "func.call"(%8, %10) <{callee = @add_nuw}> : (!transfer.integer, !transfer.integer) -> i1
    %13 = "transfer.and"(%0, %11) : (!transfer.integer, !transfer.integer) -> !transfer.integer
