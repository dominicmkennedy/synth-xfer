"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer):
    ...
    %6 = "transfer.shl"(%5, %0) : (!transfer.integer, !transfer.integer) -> !transfer.integer
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer):
    %4 = "arith.constant"() <{value = true}> : () -> i1
    %5 = "transfer.shl"(%2, %1) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    ...
    %8 = "transfer.xor"(%3, %5) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %9 = "transfer.shl"(%8, %0) : (!transfer.integer, !transfer.integer) -> !transfer.integer
