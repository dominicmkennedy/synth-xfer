"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer):
    %4 = "transfer.sdiv"(%0, %1) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %5 = "transfer.shl"(%4, %2) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %6 = "transfer.ashr"(%5, %3) : (!transfer.integer, !transfer.integer) -> !transfer.integer
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer):
    %4 = "arith.constant"() <{value = true}> : () -> i1
    %5 = "transfer.sdiv"(%0, %1) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %6 = "func.call"(%0, %1) <{callee = @sidv_exact}> : (!transfer.integer, !transfer.integer) -> i1
    %7 = "func.call"(%0, %1) <{callee = @rhs_neq_zero}> : (!transfer.integer, !transfer.integer) -> i1
    %8 = "transfer.shl"(%5, %2) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %9 = "func.call"(%5, %2) <{callee = @shifting_amount_less_bitwidth}> : (!transfer.integer, !transfer.integer) -> i1
    %10 = "transfer.ashr"(%8, %3) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %11 = "func.call"(%8, %3) <{callee = @ashr_exact}> : (!transfer.integer, !transfer.integer) -> i1
