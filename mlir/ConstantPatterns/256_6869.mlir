"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer, %4 : !transfer.integer):
    ...
    %8 = "func.call"(%1, %6) <{callee = @add_nuw}> : (!transfer.integer, !transfer.integer) -> i1
    %9 = "transfer.and"(%0, %7) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %10 = "transfer.sub"(%4, %9) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %11 = "func.call"(%4, %9) <{callee = @sub_nsw}> : (!transfer.integer, !transfer.integer) -> i1
