"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer):
    %3 = "transfer.add"(%1, %0) : (!transfer.integer, !transfer.integer) -> !transfer.integer
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer):
    ...
    %5 = "func.call"(%1, %0) <{callee = @add_nuw}> : (!transfer.integer, !transfer.integer) -> i1
    %6 = "func.call"(%1, %0) <{callee = @add_nsw}> : (!transfer.integer, !transfer.integer) -> i1
    %7 = "transfer.shl"(%4, %2) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %8 = "func.call"(%4, %2) <{callee = @shl_nuw}> : (!transfer.integer, !transfer.integer) -> i1
    %9 = "func.call"(%4, %2) <{callee = @shl_nsw}> : (!transfer.integer, !transfer.integer) -> i1
    %10 = "func.call"(%4, %2) <{callee = @shifting_amount_less_bitwidth}> : (!transfer.integer, !transfer.integer) -> i1
