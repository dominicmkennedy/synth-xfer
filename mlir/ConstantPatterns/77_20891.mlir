"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer):
    ...
    %4 = "transfer.lshr"(%0, %2) : (!transfer.integer, !transfer.integer) -> !transfer.integer
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer):
    ...
    %6 = "transfer.lshr"(%0, %2) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %7 = "func.call"(%0, %2) <{callee = @shifting_amount_less_bitwidth}> : (!transfer.integer, !transfer.integer) -> i1
    %8 = "transfer.xor"(%4, %6) : (!transfer.integer, !transfer.integer) -> !transfer.integer
