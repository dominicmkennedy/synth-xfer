"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer):
    ...
    %6 = "transfer.shl"(%5, %3) : (!transfer.integer, !transfer.integer) -> !transfer.integer
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer):
    ...
    %7 = "transfer.add"(%0, %5) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %8 = "func.call"(%0, %5) <{callee = @add_nuw}> : (!transfer.integer, !transfer.integer) -> i1
    %9 = "transfer.shl"(%7, %3) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %10 = "func.call"(%7, %3) <{callee = @shl_nuw}> : (!transfer.integer, !transfer.integer) -> i1
