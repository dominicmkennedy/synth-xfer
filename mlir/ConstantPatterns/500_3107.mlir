"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer):
    ...
    %6 = "transfer.sub"(%5, %1) : (!transfer.integer, !transfer.integer) -> !transfer.integer
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer):
    ...
    %6 = "transfer.sub"(%5, %0) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %7 = "func.call"(%5, %0) <{callee = @sub_nsw}> : (!transfer.integer, !transfer.integer) -> i1
    %8 = "transfer.sub"(%6, %1) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %9 = "func.call"(%6, %1) <{callee = @sub_nsw}> : (!transfer.integer, !transfer.integer) -> i1
    %10 = "transfer.sub"(%3, %8) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %11 = "func.call"(%3, %8) <{callee = @sub_nsw}> : (!transfer.integer, !transfer.integer) -> i1
