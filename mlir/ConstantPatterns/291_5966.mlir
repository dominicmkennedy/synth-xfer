"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer, %4 : !transfer.integer):
    ...
    %6 = "transfer.and"(%1, %5) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %7 = "transfer.add"(%4, %0) : (!transfer.integer, !transfer.integer) -> !transfer.integer
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer, %4 : !transfer.integer):
    %5 = "arith.constant"() <{value = true}> : () -> i1
    %6 = "transfer.add"(%2, %3) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %7 = "func.call"(%2, %3) <{callee = @add_nuw}> : (!transfer.integer, !transfer.integer) -> i1
    %8 = "transfer.and"(%1, %6) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %9 = "transfer.add"(%4, %0) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %10 = "transfer.add"(%8, %9) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %11 = "func.call"(%8, %9) <{callee = @add_nuw}> : (!transfer.integer, !transfer.integer) -> i1
