"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer):
    ...
    %4 = "transfer.ashr"(%3, %2) : (!transfer.integer, !transfer.integer) -> !transfer.integer
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer):
    ...
    %6 = "transfer.ashr"(%4, %2) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %7 = "func.call"(%4, %2) <{callee = @ashr_exact}> : (!transfer.integer, !transfer.integer) -> i1
