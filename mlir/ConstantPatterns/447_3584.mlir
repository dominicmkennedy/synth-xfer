"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer, %4 : !transfer.integer, %5 : !transfer.integer):
    %6 = "arith.constant"() <{value = true}> : () -> i1
    %7 = "transfer.and"(%3, %2) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %8 = "transfer.lshr"(%1, %4) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %9 = "func.call"(%1, %4) <{callee = @shifting_amount_less_bitwidth}> : (!transfer.integer, !transfer.integer) -> i1
    %10 = "transfer.and"(%5, %8) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %11 = "transfer.or"(%7, %10) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %12 = "func.call"(%7, %10) <{callee = @or_disjoint}> : (!transfer.integer, !transfer.integer) -> i1
    %13 = "transfer.or"(%0, %11) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %14 = "func.call"(%0, %11) <{callee = @or_disjoint}> : (!transfer.integer, !transfer.integer) -> i1
    %15 = "arith.andi"(%6, %9) : (i1, i1) -> i1
