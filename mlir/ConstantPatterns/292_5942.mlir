"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer):
    %3 = "transfer.shl"(%1, %2) : (!transfer.integer, !transfer.integer) -> !transfer.integer
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer):
    ...
    %5 = "func.call"(%1, %2) <{callee = @shl_nuw}> : (!transfer.integer, !transfer.integer) -> i1
    %6 = "func.call"(%1, %2) <{callee = @shl_nsw}> : (!transfer.integer, !transfer.integer) -> i1
    %7 = "func.call"(%1, %2) <{callee = @shifting_amount_less_bitwidth}> : (!transfer.integer, !transfer.integer) -> i1
    %8 = "transfer.add"(%0, %4) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %9 = "func.call"(%0, %4) <{callee = @add_nuw}> : (!transfer.integer, !transfer.integer) -> i1
    %10 = "func.call"(%0, %4) <{callee = @add_nsw}> : (!transfer.integer, !transfer.integer) -> i1
    %11 = "arith.andi"(%3, %5) : (i1, i1) -> i1
    %12 = "arith.andi"(%11, %6) : (i1, i1) -> i1
    %13 = "arith.andi"(%12, %7) : (i1, i1) -> i1
