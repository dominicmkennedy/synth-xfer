"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer, %4 : !transfer.integer, %5 : !transfer.integer):
    ...
    %10 = "func.call"(%0, %8) <{callee = @or_disjoint}> : (!transfer.integer, !transfer.integer) -> i1
    %11 = "transfer.and"(%5, %9) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %12 = "transfer.or"(%7, %11) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %13 = "func.call"(%7, %11) <{callee = @or_disjoint}> : (!transfer.integer, !transfer.integer) -> i1
