"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer, %4 : !transfer.integer):
    ...
    %6 = "transfer.and"(%3, %0) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %7 = "transfer.or"(%5, %6) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %8 = "transfer.and"(%4, %7) : (!transfer.integer, !transfer.integer) -> !transfer.integer
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer, %4 : !transfer.integer):
    ...
    %7 = "transfer.and"(%3, %0) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %8 = "transfer.or"(%6, %7) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %9 = "func.call"(%6, %7) <{callee = @or_disjoint}> : (!transfer.integer, !transfer.integer) -> i1
    %10 = "transfer.and"(%4, %8) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %11 = "arith.andi"(%5, %9) : (i1, i1) -> i1
    "func.return"(%11) : (i1) -> ()
  }) : () -> ()
