"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer, %4 : !transfer.integer, %5 : !transfer.integer):
    ...
    %7 = "transfer.lshr"(%1, %4) : (!transfer.integer, !transfer.integer) -> !transfer.integer
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer, %4 : !transfer.integer, %5 : !transfer.integer):
    %6 = "arith.constant"() <{value = true}> : () -> i1
    %7 = "transfer.lshr"(%2, %3) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %8 = "func.call"(%2, %3) <{callee = @shifting_amount_less_bitwidth}> : (!transfer.integer, !transfer.integer) -> i1
    %9 = "transfer.lshr"(%1, %4) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %10 = "func.call"(%1, %4) <{callee = @shifting_amount_less_bitwidth}> : (!transfer.integer, !transfer.integer) -> i1
    %11 = "transfer.and"(%5, %9) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %12 = "transfer.or"(%0, %11) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %13 = "func.call"(%0, %11) <{callee = @or_disjoint}> : (!transfer.integer, !transfer.integer) -> i1
    %14 = "transfer.or"(%7, %12) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %15 = "func.call"(%7, %12) <{callee = @or_disjoint}> : (!transfer.integer, !transfer.integer) -> i1
