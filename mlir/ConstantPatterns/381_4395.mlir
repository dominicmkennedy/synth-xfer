"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer, %4 : !transfer.integer):
    ...
    %6 = "transfer.lshr"(%0, %3) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %7 = "transfer.add"(%5, %6) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %8 = "transfer.shl"(%7, %4) : (!transfer.integer, !transfer.integer) -> !transfer.integer
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer, %4 : !transfer.integer):
    ...
    %8 = "transfer.lshr"(%0, %3) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %9 = "func.call"(%0, %3) <{callee = @shifting_amount_less_bitwidth}> : (!transfer.integer, !transfer.integer) -> i1
    %10 = "transfer.add"(%6, %8) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %11 = "func.call"(%6, %8) <{callee = @add_nuw}> : (!transfer.integer, !transfer.integer) -> i1
    %12 = "transfer.shl"(%10, %4) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %13 = "func.call"(%10, %4) <{callee = @shl_nuw}> : (!transfer.integer, !transfer.integer) -> i1
