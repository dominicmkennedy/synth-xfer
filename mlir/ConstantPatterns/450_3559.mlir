"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer, %4 : !transfer.integer, %5 : !transfer.integer):
    %6 = "transfer.mul"(%3, %2) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %7 = "transfer.xor"(%0, %1) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %8 = "transfer.mul"(%4, %7) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %9 = "transfer.lshr"(%8, %5) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %10 = "transfer.xor"(%6, %9) : (!transfer.integer, !transfer.integer) -> !transfer.integer
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer, %4 : !transfer.integer, %5 : !transfer.integer):
    %6 = "arith.constant"() <{value = true}> : () -> i1
    %7 = "transfer.mul"(%3, %2) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %8 = "transfer.xor"(%0, %1) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %9 = "transfer.mul"(%4, %8) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %10 = "transfer.lshr"(%9, %5) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %11 = "func.call"(%9, %5) <{callee = @shifting_amount_less_bitwidth}> : (!transfer.integer, !transfer.integer) -> i1
    %12 = "transfer.xor"(%7, %10) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %13 = "arith.andi"(%6, %11) : (i1, i1) -> i1
    "func.return"(%13) : (i1) -> ()
  }) : () -> ()
