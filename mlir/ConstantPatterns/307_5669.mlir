"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer, %4 : !transfer.integer, %5 : !transfer.integer):
    ...
    %8 = "transfer.and"(%1, %7) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %9 = "transfer.add"(%5, %0) : (!transfer.integer, !transfer.integer) -> !transfer.integer
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer, %4 : !transfer.integer, %5 : !transfer.integer):
    %6 = "arith.constant"() <{value = true}> : () -> i1
    %7 = "transfer.mul"(%3, %4) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %8 = "func.call"(%3, %4) <{callee = @mul_nuw}> : (!transfer.integer, !transfer.integer) -> i1
    %9 = "transfer.add"(%2, %7) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %10 = "func.call"(%2, %7) <{callee = @add_nuw}> : (!transfer.integer, !transfer.integer) -> i1
    %11 = "transfer.and"(%1, %9) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %12 = "transfer.add"(%5, %0) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %13 = "transfer.add"(%11, %12) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %14 = "func.call"(%11, %12) <{callee = @add_nuw}> : (!transfer.integer, !transfer.integer) -> i1
