"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer):
    %4 = "transfer.sdiv"(%1, %2) : (!transfer.integer, !transfer.integer) -> !transfer.integer
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer):
    %4 = "arith.constant"() <{value = true}> : () -> i1
    %5 = "transfer.sdiv"(%1, %2) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %6 = "func.call"(%1, %2) <{callee = @rhs_neq_zero}> : (!transfer.integer, !transfer.integer) -> i1
    %7 = "transfer.shl"(%5, %3) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %8 = "func.call"(%5, %3) <{callee = @shl_nsw}> : (!transfer.integer, !transfer.integer) -> i1
    %9 = "func.call"(%5, %3) <{callee = @shifting_amount_less_bitwidth}> : (!transfer.integer, !transfer.integer) -> i1
    %10 = "transfer.add"(%0, %7) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %11 = "func.call"(%0, %7) <{callee = @add_nsw}> : (!transfer.integer, !transfer.integer) -> i1
