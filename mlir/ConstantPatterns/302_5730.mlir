"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer, %4 : !transfer.integer):
    %5 = "transfer.and"(%2, %1) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %6 = "transfer.shl"(%3, %5) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %7 = "transfer.xor"(%4, %6) : (!transfer.integer, !transfer.integer) -> !transfer.integer
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer, %4 : !transfer.integer):
    %5 = "arith.constant"() <{value = true}> : () -> i1
    %6 = "transfer.and"(%2, %1) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %7 = "transfer.shl"(%3, %6) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %8 = "func.call"(%3, %6) <{callee = @shl_nuw}> : (!transfer.integer, !transfer.integer) -> i1
    %9 = "func.call"(%3, %6) <{callee = @shifting_amount_less_bitwidth}> : (!transfer.integer, !transfer.integer) -> i1
    %10 = "transfer.xor"(%4, %7) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %11 = "transfer.and"(%0, %10) : (!transfer.integer, !transfer.integer) -> !transfer.integer
