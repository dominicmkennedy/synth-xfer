"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer, %4 : !transfer.integer):
    ...
    %6 = "transfer.mul"(%0, %1) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %7 = "transfer.add"(%4, %2) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %8 = "transfer.add"(%6, %7) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %9 = "transfer.and"(%5, %8) : (!transfer.integer, !transfer.integer) -> !transfer.integer
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer, %4 : !transfer.integer):
    %5 = "arith.constant"() <{value = true}> : () -> i1
    %6 = "transfer.sub"(%3, %2) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %7 = "transfer.mul"(%0, %1) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %8 = "func.call"(%0, %1) <{callee = @mul_nuw}> : (!transfer.integer, !transfer.integer) -> i1
    %9 = "transfer.add"(%4, %2) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    ...
    %12 = "transfer.and"(%6, %10) : (!transfer.integer, !transfer.integer) -> !transfer.integer
