"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer):
    ...
    %8 = "transfer.add"(%2, %4) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %9 = "func.call"(%2, %4) <{callee = @add_nuw}> : (!transfer.integer, !transfer.integer) -> i1
    %10 = "func.call"(%2, %4) <{callee = @add_nsw}> : (!transfer.integer, !transfer.integer) -> i1
