"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer):
    ...
    %6 = "func.call"(%1, %0) <{callee = @add_nuw}> : (!transfer.integer, !transfer.integer) -> i1
    %7 = "func.call"(%1, %0) <{callee = @add_nsw}> : (!transfer.integer, !transfer.integer) -> i1
    %8 = "transfer.lshr"(%5, %2) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %9 = "func.call"(%5, %2) <{callee = @shifting_amount_less_bitwidth}> : (!transfer.integer, !transfer.integer) -> i1
    %10 = "transfer.add"(%3, %8) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %11 = "func.call"(%3, %8) <{callee = @add_nuw}> : (!transfer.integer, !transfer.integer) -> i1
    %12 = "func.call"(%3, %8) <{callee = @add_nsw}> : (!transfer.integer, !transfer.integer) -> i1
