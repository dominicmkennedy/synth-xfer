"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer, %4 : !transfer.integer):
    ...
    %6 = "transfer.shl"(%0, %3) : (!transfer.integer, !transfer.integer) -> !transfer.integer
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer, %4 : !transfer.integer):
    ...
    %8 = "transfer.shl"(%0, %3) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %9 = "func.call"(%0, %3) <{callee = @shifting_amount_less_bitwidth}> : (!transfer.integer, !transfer.integer) -> i1
    %10 = "transfer.and"(%4, %8) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %11 = "transfer.or"(%6, %10) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %12 = "func.call"(%6, %10) <{callee = @or_disjoint}> : (!transfer.integer, !transfer.integer) -> i1
