"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer, %4 : !transfer.integer):
    ...
    %6 = "transfer.or"(%1, %5) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %7 = "transfer.shl"(%0, %4) : (!transfer.integer, !transfer.integer) -> !transfer.integer
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer, %4 : !transfer.integer):
    %5 = "arith.constant"() <{value = true}> : () -> i1
    %6 = "transfer.shl"(%2, %3) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %7 = "func.call"(%2, %3) <{callee = @shl_nuw}> : (!transfer.integer, !transfer.integer) -> i1
    %8 = "func.call"(%2, %3) <{callee = @shl_nsw}> : (!transfer.integer, !transfer.integer) -> i1
    %9 = "func.call"(%2, %3) <{callee = @shifting_amount_less_bitwidth}> : (!transfer.integer, !transfer.integer) -> i1
    %10 = "transfer.or"(%1, %6) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %11 = "func.call"(%1, %6) <{callee = @or_disjoint}> : (!transfer.integer, !transfer.integer) -> i1
    %12 = "transfer.shl"(%0, %4) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %13 = "func.call"(%0, %4) <{callee = @shl_nuw}> : (!transfer.integer, !transfer.integer) -> i1
    %14 = "func.call"(%0, %4) <{callee = @shl_nsw}> : (!transfer.integer, !transfer.integer) -> i1
    %15 = "func.call"(%0, %4) <{callee = @shifting_amount_less_bitwidth}> : (!transfer.integer, !transfer.integer) -> i1
    %16 = "transfer.or"(%10, %12) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %17 = "func.call"(%10, %12) <{callee = @or_disjoint}> : (!transfer.integer, !transfer.integer) -> i1
