"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer):
    ...
    %5 = "func.call"(%2, %1) <{callee = @add_nsw}> : (!transfer.integer, !transfer.integer) -> i1
    %6 = "transfer.sub"(%4, %0) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %7 = "func.call"(%4, %0) <{callee = @sub_nsw}> : (!transfer.integer, !transfer.integer) -> i1
