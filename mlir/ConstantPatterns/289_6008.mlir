"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer, %4 : !transfer.integer):
    %5 = "transfer.add"(%4, %3) : (!transfer.integer, !transfer.integer) -> !transfer.integer
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer, %4 : !transfer.integer):
    ...
    %9 = "transfer.add"(%1, %7) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %10 = "func.call"(%1, %7) <{callee = @add_nuw}> : (!transfer.integer, !transfer.integer) -> i1
