"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer):
    %3 = "transfer.mul"(%1, %0) : (!transfer.integer, !transfer.integer) -> !transfer.integer
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer):
    ...
    %5 = "func.call"(%1, %0) <{callee = @mul_nuw}> : (!transfer.integer, !transfer.integer) -> i1
    %6 = "func.call"(%1, %0) <{callee = @mul_nsw}> : (!transfer.integer, !transfer.integer) -> i1
    %7 = "transfer.add"(%2, %4) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %8 = "func.call"(%2, %4) <{callee = @add_nuw}> : (!transfer.integer, !transfer.integer) -> i1
    %9 = "func.call"(%2, %4) <{callee = @add_nsw}> : (!transfer.integer, !transfer.integer) -> i1
