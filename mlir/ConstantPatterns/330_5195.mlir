"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer, %4 : !transfer.integer):
    %5 = "transfer.xor"(%2, %3) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %6 = "transfer.xor"(%1, %5) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %7 = "transfer.xor"(%0, %6) : (!transfer.integer, !transfer.integer) -> !transfer.integer
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer, %4 : !transfer.integer):
    %5 = "arith.constant"() <{value = true}> : () -> i1
    %6 = "transfer.xor"(%2, %3) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %7 = "transfer.xor"(%1, %6) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    ...
    %10 = "func.call"(%8, %4) <{callee = @shifting_amount_less_bitwidth}> : (!transfer.integer, !transfer.integer) -> i1
    %11 = "arith.andi"(%5, %10) : (i1, i1) -> i1
    "func.return"(%11) : (i1) -> ()
  }) : () -> ()
