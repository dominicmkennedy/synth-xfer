"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer):
    ...
    %4 = "transfer.udiv"(%3, %2) : (!transfer.integer, !transfer.integer) -> !transfer.integer
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer):
    ...
    %6 = "transfer.udiv"(%4, %2) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %7 = "func.call"(%4, %2) <{callee = @udiv_exact}> : (!transfer.integer, !transfer.integer) -> i1
    %8 = "func.call"(%4, %2) <{callee = @rhs_neq_zero}> : (!transfer.integer, !transfer.integer) -> i1
