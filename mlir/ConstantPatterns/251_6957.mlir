"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer):
    %4 = "arith.constant"() <{value = true}> : () -> i1
    %5 = "transfer.shl"(%0, %1) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %6 = "func.call"(%0, %1) <{callee = @shifting_amount_less_bitwidth}> : (!transfer.integer, !transfer.integer) -> i1
    %7 = "transfer.add"(%2, %5) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %8 = "transfer.ashr"(%7, %3) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %9 = "func.call"(%7, %3) <{callee = @ashr_exact}> : (!transfer.integer, !transfer.integer) -> i1
