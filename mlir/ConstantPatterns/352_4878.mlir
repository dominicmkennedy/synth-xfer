"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer):
    ...
    %7 = "func.call"(%0, %5) <{callee = @add_nuw}> : (!transfer.integer, !transfer.integer) -> i1
    %8 = "func.call"(%0, %5) <{callee = @add_nsw}> : (!transfer.integer, !transfer.integer) -> i1
    %9 = "transfer.lshr"(%6, %3) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %10 = "func.call"(%6, %3) <{callee = @shifting_amount_less_bitwidth}> : (!transfer.integer, !transfer.integer) -> i1
