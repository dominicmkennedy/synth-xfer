"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer):
    %4 = "transfer.and"(%1, %0) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %5 = "transfer.shl"(%2, %4) : (!transfer.integer, !transfer.integer) -> !transfer.integer
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer):
    %4 = "arith.constant"() <{value = true}> : () -> i1
    %5 = "transfer.and"(%1, %0) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %6 = "transfer.shl"(%2, %5) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %7 = "func.call"(%2, %5) <{callee = @shl_nuw}> : (!transfer.integer, !transfer.integer) -> i1
    %8 = "func.call"(%2, %5) <{callee = @shifting_amount_less_bitwidth}> : (!transfer.integer, !transfer.integer) -> i1
    %9 = "transfer.xor"(%3, %6) : (!transfer.integer, !transfer.integer) -> !transfer.integer
