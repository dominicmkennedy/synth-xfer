"builtin.module"() ({
  ...
  ^0(%0 : !transfer.abs_value<[!transfer.integer, !transfer.integer]>, %1 : !transfer.abs_value<[!transfer.integer, !transfer.integer]>, %2 : !transfer.abs_value<[!transfer.integer, !transfer.integer]>, %3 : !transfer.abs_value<[!transfer.integer, !transfer.integer]>, %4 : !transfer.abs_value<[!transfer.integer, !transfer.integer]>, %5 : !transfer.abs_value<[!transfer.integer, !transfer.integer]>):
    ...
    %9 = "func.call"(%5) <{callee = @constant_constraint}> : (!transfer.abs_value<[!transfer.integer, !transfer.integer]>) -> i1
    %10 = "arith.andi"(%6, %7) : (i1, i1) -> i1
    %11 = "arith.andi"(%10, %8) : (i1, i1) -> i1
    %12 = "arith.andi"(%11, %9) : (i1, i1) -> i1
    "func.return"(%12) : (i1) -> ()
  }) : () -> ()
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer, %4 : !transfer.integer, %5 : !transfer.integer):
    ...
    %7 = "transfer.and"(%4, %6) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %8 = "transfer.and"(%5, %1) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %9 = "transfer.or"(%0, %8) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %10 = "transfer.or"(%7, %9) : (!transfer.integer, !transfer.integer) -> !transfer.integer
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer, %4 : !transfer.integer, %5 : !transfer.integer):
    %6 = "arith.constant"() <{value = true}> : () -> i1
    %7 = "transfer.shl"(%2, %3) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %8 = "func.call"(%2, %3) <{callee = @shifting_amount_less_bitwidth}> : (!transfer.integer, !transfer.integer) -> i1
    %9 = "transfer.and"(%4, %7) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %10 = "transfer.and"(%5, %1) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %11 = "transfer.or"(%0, %10) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %12 = "func.call"(%0, %10) <{callee = @or_disjoint}> : (!transfer.integer, !transfer.integer) -> i1
    %13 = "transfer.or"(%9, %11) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %14 = "func.call"(%9, %11) <{callee = @or_disjoint}> : (!transfer.integer, !transfer.integer) -> i1
    %15 = "arith.andi"(%6, %8) : (i1, i1) -> i1
    %16 = "arith.andi"(%15, %12) : (i1, i1) -> i1
