"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer, %4 : !transfer.integer):
    ...
    %8 = "transfer.add"(%1, %6) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %9 = "func.call"(%1, %6) <{callee = @add_nuw}> : (!transfer.integer, !transfer.integer) -> i1
    %10 = "transfer.and"(%0, %8) : (!transfer.integer, !transfer.integer) -> !transfer.integer
