"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer):
    %4 = "transfer.mul"(%1, %0) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %5 = "transfer.add"(%2, %4) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %6 = "transfer.lshr"(%5, %3) : (!transfer.integer, !transfer.integer) -> !transfer.integer
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer):
    ...
    %6 = "func.call"(%1, %0) <{callee = @mul_nuw}> : (!transfer.integer, !transfer.integer) -> i1
    %7 = "func.call"(%1, %0) <{callee = @mul_nsw}> : (!transfer.integer, !transfer.integer) -> i1
    %8 = "transfer.add"(%2, %5) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %9 = "func.call"(%2, %5) <{callee = @add_nuw}> : (!transfer.integer, !transfer.integer) -> i1
    %10 = "func.call"(%2, %5) <{callee = @add_nsw}> : (!transfer.integer, !transfer.integer) -> i1
    %11 = "transfer.lshr"(%8, %3) : (!transfer.integer, !transfer.integer) -> !transfer.integer
