"builtin.module"() ({
  ...
  ^0(%0 : !transfer.abs_value<[!transfer.integer, !transfer.integer]>, %1 : !transfer.abs_value<[!transfer.integer, !transfer.integer]>, %2 : !transfer.abs_value<[!transfer.integer, !transfer.integer]>, %3 : !transfer.abs_value<[!transfer.integer, !transfer.integer]>, %4 : !transfer.abs_value<[!transfer.integer, !transfer.integer]>):
    ...
    %6 = "func.call"(%1) <{callee = @constant_constraint}> : (!transfer.abs_value<[!transfer.integer, !transfer.integer]>) -> i1
    ...
    %10 = "arith.andi"(%5, %6) : (i1, i1) -> i1
    %11 = "arith.andi"(%10, %7) : (i1, i1) -> i1
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer, %4 : !transfer.integer):
    %5 = "transfer.xor"(%1, %0) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %6 = "transfer.mul"(%2, %5) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %7 = "transfer.add"(%3, %6) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %8 = "transfer.lshr"(%7, %4) : (!transfer.integer, !transfer.integer) -> !transfer.integer
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer, %4 : !transfer.integer):
    %5 = "arith.constant"() <{value = true}> : () -> i1
    %6 = "transfer.xor"(%1, %0) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %7 = "transfer.mul"(%2, %6) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %8 = "func.call"(%2, %6) <{callee = @mul_nuw}> : (!transfer.integer, !transfer.integer) -> i1
    %9 = "func.call"(%2, %6) <{callee = @mul_nsw}> : (!transfer.integer, !transfer.integer) -> i1
    %10 = "transfer.add"(%3, %7) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %11 = "func.call"(%3, %7) <{callee = @add_nuw}> : (!transfer.integer, !transfer.integer) -> i1
    %12 = "func.call"(%3, %7) <{callee = @add_nsw}> : (!transfer.integer, !transfer.integer) -> i1
    %13 = "transfer.lshr"(%10, %4) : (!transfer.integer, !transfer.integer) -> !transfer.integer
