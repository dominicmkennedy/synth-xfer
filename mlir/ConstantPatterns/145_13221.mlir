"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer):
    ...
    %5 = "transfer.ashr"(%4, %2) : (!transfer.integer, !transfer.integer) -> !transfer.integer
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer):
    ...
    %7 = "func.call"(%5, %2) <{callee = @ashr_exact}> : (!transfer.integer, !transfer.integer) -> i1
    %8 = "func.call"(%5, %2) <{callee = @shifting_amount_less_bitwidth}> : (!transfer.integer, !transfer.integer) -> i1
    %9 = "transfer.add"(%3, %6) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %10 = "func.call"(%3, %6) <{callee = @add_nsw}> : (!transfer.integer, !transfer.integer) -> i1
