"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer):
    %3 = "transfer.sdiv"(%0, %1) : (!transfer.integer, !transfer.integer) -> !transfer.integer
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer):
    ...
    %5 = "func.call"(%0, %1) <{callee = @sidv_exact}> : (!transfer.integer, !transfer.integer) -> i1
    %6 = "func.call"(%0, %1) <{callee = @rhs_neq_zero}> : (!transfer.integer, !transfer.integer) -> i1
    %7 = "transfer.shl"(%4, %2) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %8 = "func.call"(%4, %2) <{callee = @shifting_amount_less_bitwidth}> : (!transfer.integer, !transfer.integer) -> i1
