"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer):
    %4 = "transfer.xor"(%1, %0) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %5 = "transfer.mul"(%2, %4) : (!transfer.integer, !transfer.integer) -> !transfer.integer
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer):
    ...
    %7 = "func.call"(%2, %5) <{callee = @mul_nuw}> : (!transfer.integer, !transfer.integer) -> i1
    %8 = "func.call"(%2, %5) <{callee = @mul_nsw}> : (!transfer.integer, !transfer.integer) -> i1
