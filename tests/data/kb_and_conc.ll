...
{
entry:
  %"lhs_known_z" = extractvalue [2 x i4] %".1", 0
  %"lhs_known_o" = extractvalue [2 x i4] %".1", 1
  %"rhs_known_z" = extractvalue [2 x i4] %".2", 0
  %"rhs_known_o" = extractvalue [2 x i4] %".2", 1
  %".4" = or i4 %"lhs_known_z", %"rhs_known_z"
  %".5" = or i4 %"lhs_known_o", %"rhs_known_o"
...
{
entry:
  %"lhs_known_z" = extractvalue [2 x i8] %".1", 0
  %"lhs_known_o" = extractvalue [2 x i8] %".1", 1
  %"rhs_known_z" = extractvalue [2 x i8] %".2", 0
  %"rhs_known_o" = extractvalue [2 x i8] %".2", 1
  %".4" = or i8 %"lhs_known_z", %"rhs_known_z"
  %".5" = or i8 %"lhs_known_o", %"rhs_known_o"
...
{
entry:
  %"lhs_known_z" = extractvalue [2 x i64] %".1", 0
  %"lhs_known_o" = extractvalue [2 x i64] %".1", 1
  %"rhs_known_z" = extractvalue [2 x i64] %".2", 0
  %"rhs_known_o" = extractvalue [2 x i64] %".2", 1
  %".4" = or i64 %"lhs_known_z", %"rhs_known_z"
  %".5" = or i64 %"lhs_known_o", %"rhs_known_o"
