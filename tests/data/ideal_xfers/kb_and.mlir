func.func @kb_and(%lhs : !transfer.abs_value<[!transfer.integer, !transfer.integer]>, %rhs : !transfer.abs_value<[!transfer.integer, !transfer.integer]>) -> !transfer.abs_value<[!transfer.integer, !transfer.integer]> {
  ...
  %res0 = transfer.or %lhs0, %rhs0 : !transfer.integer
  %res1 = transfer.and %lhs1, %rhs1 : !transfer.integer
