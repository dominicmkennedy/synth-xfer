...
Implement or improve a KnownBits transfer function for operation `mul` in this repo
...
Operation: mlir/Operations/Mul.mlir
```mlir
"builtin.module"() ({
  "func.func"() ({
...
Generate kb_mul.mlir by filling in only the TODO parts.