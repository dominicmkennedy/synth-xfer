...
Implement or improve a KnownBits transfer function for operation `umax` in this repo
...
Operation: mlir/Operations/Umax.mlir
```mlir
"builtin.module"() ({
  "func.func"() ({
...
Generate kb_umax.mlir by filling in only the TODO parts.