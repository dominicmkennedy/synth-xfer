...
Implement or improve a KnownBits transfer function for operation `add` in this repo
...
Operation: mlir/Operations/Add.mlir
```mlir
"builtin.module"() ({
  "func.func"() ({
...
Generate kb_add.mlir by filling in only the TODO parts.